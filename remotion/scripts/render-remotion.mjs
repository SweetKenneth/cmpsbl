...
await renderMedia({ composition, serveUrl: bundled, codec: "h264", outputLocation: "/mnt/documents/dream-state-teaser.mp4", puppeteerInstance: browser, muted: true, concurrency: 1 });
await browser.close({ silent: false });
console.log("Done: /mnt/documents/dream-state-teaser.mp4");
