...
const ENGINE_PRICE_IDS: Record<string, { price_id: string; mode: "payment" | "subscription" }> = {
  ...
  // S-TIER Wave 2 ($39 — displayed as APEX tier on site)
  pandora:      { price_id: PRICE_APEX, mode: "payment" },
  hydra:        { price_id: PRICE_APEX, mode: "payment" },
  specter:      { price_id: PRICE_APEX, mode: "payment" },
  "atlas-engine": { price_id: PRICE_APEX, mode: "payment" },
  cerberus:     { price_id: PRICE_APEX, mode: "payment" },
  obelisk:      { price_id: PRICE_APEX, mode: "payment" },
  phoenix:      { price_id: PRICE_APEX, mode: "payment" },
  "nexus-prime": { price_id: PRICE_APEX, mode: "payment" },
  chronos:      { price_id: PRICE_APEX, mode: "payment" },
  golem:        { price_id: PRICE_APEX, mode: "payment" },

  // S-TIER Wave 3 ($39 — displayed as APEX tier on site)
  axiom:        { price_id: PRICE_APEX, mode: "payment" },
  dynamo:       { price_id: PRICE_APEX, mode: "payment" },
  warden:       { price_id: PRICE_APEX, mode: "payment" },
  synapse:      { price_id: PRICE_APEX, mode: "payment" },
  crucible:     { price_id: PRICE_APEX, mode: "payment" },
  echo:         { price_id: PRICE_APEX, mode: "payment" },
  vortex:       { price_id: PRICE_APEX, mode: "payment" },
  monolith:     { price_id: PRICE_APEX, mode: "payment" },
  seraph:       { price_id: PRICE_APEX, mode: "payment" },
  progenitor:   { price_id: PRICE_APEX, mode: "payment" },
