...
const SKIP_TABLES = new Set<string>([
  ...
  'ai_usage_log',              // ~157K rows — API call counters, regenerated
  'brain_events',              // ~88K rows — event stream, regenerated by BRAIN
  'brain_maintenance_log',     // ~21K rows — maintenance telemetry
  'analytics_events',          // ~15K rows — page event telemetry
  'site_page_views',           // ~8K rows — visitor analytics, regenerated
  'brain_memory_pruned',       // ~5K rows — pruning artifacts (source data retained in warm/cold)
  'site_sessions',             // ~1.6K rows — session tracking, regenerated
  'defense_events',            // ~2.2K rows — security event stream, regenerated by DEFENSE
  'client_error_log',          // error telemetry, regenerated
  'learning_queries',          // transient learning queue
