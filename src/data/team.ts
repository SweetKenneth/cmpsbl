...
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Priya Nakamura is a junior developer and DevOps engineer at CMPSBL, working on CI/CD pipelines, artifact pack tooling, and developer experience. She contributes to the MODERNIZER module's self-upgrade capabilities and maintains the substrate's deployment infrastructure.",
