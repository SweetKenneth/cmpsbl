...
const ALL_ROUTES: SearchableRoute[] = [
  ...
  { name: "Plans & Pricing", href: "/plans", section: "Product", icon: Gauge, keywords: ["pricing", "plans", "tiers", "billing", "upgrade"] },
  ...
  { name: "Developer Tools", href: "/devtools", section: "Build", icon: Terminal },
