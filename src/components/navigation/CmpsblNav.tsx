  ...
  const navSections: NavSection[] = [
    {
      ...
      items: [
        ...
        { name: "Architecture", href: "/architecture", description: "Agents, Engines, Layers & Organs", icon: Layers },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Developers", href: "/developers", description: "Community & resources", icon: Users },
      ]
    },
  ];
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative h-full pt-28 pb-[env(safe-area-inset-bottom,2rem)] px-5 overflow-y-auto overscroll-contain momentum-scroll"
