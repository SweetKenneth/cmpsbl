...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    body: 'Autonomous AI that learns and executes. Each agent ships with 4-tier memory, continuous learning, and a Convex Core™ artifact. FAILSAFE is free — higher tiers unlock AEGIS, SPECTRA, PHANTOM Agent, and RAPTOR.',
    accent: 'neon-cyan',
...
export function StoreOnboarding() {
  ...
  const { trackOpened, trackStep, trackCompleted, trackSkipped } = useOnboardingTracking('store');
