/**
 * CodeLab Onboarding — First-visit explainer for /codelab
 * Introduces the playground, Signal Forge, templates, workbench, and recipes
 */

import { useState, useEffect } from 'react';
import { X, ArrowRight, FlaskConical, Zap, LayoutTemplate, Terminal, ChefHat } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { cn } from '@/lib/utils';
import './cmpsbl-welcome.css';

const STORAGE_KEY = 'codelab-onboarded';
...
const STEPS = [
  {
    ...
    body: 'Your interactive creation surface inside the cognitive substrate. Explore resolvers, test intents, forge signals, and build real software — all in one place.',
    accent: 'primary',
  ...
  },
  {
    ...
    tag: 'Forge',
    title: 'Signal Forge',
    body: 'Describe what you want to build. Signal Forge analyzes your intent against the 40-node capability matrix and generates a scored architecture blueprint instantly.',
    accent: 'neon-cyan',
  ...
  },
  {
    icon: LayoutTemplate,
    tag: 'Templates',
    title: '30 Free Starter Templates',
    body: 'From AI chatbots to fraud detection pipelines — pick a template, customize it, and launch. Every template is production-grade with tests, docs, and a runtime engine.',
    accent: 'neon-purple',
  ...
  },
  {
    icon: Terminal,
    tag: 'Execute',
    title: 'Live Code Workbench',
    body: 'Write and execute resolver calls in real time. See responses, inspect telemetry, and iterate without leaving the substrate. Your history persists across sessions.',
    accent: 'neon-green',
  ...
  },
  {
    ...
    body: 'Chain multiple resolvers into reusable pipelines. The Recipe Builder lets you visually compose multi-step workflows and export them as standalone capabilities.',
    accent: 'neon-amber',
...
export function CodeLabOnboarding() {
