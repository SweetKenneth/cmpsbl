...
const primitives = [
  ...
  },
  {
    ...
    title: "Defense-First",
    node: "DEFENSE Layer",
    description: "Behavioral analysis, threat detection, rate limiting, and governance rules — always on.",
  ...
  },
  {
    ...
    title: "Smart Routing",
    node: "NEXUS Organ",
    description: "Routes every request to the optimal AI provider based on task, cost, and latency — with a 12-step free-tier fallback chain.",
  ...
  },
  {
    ...
    node: "VISION Layer",
    description: "Full observability across every invocation — cost tracking, latency monitoring, confidence scoring, and health dashboards.",
  ...
  },
  {
    ...
    title: "Dream Cycles",
    node: "DREAM Engine",
    description: "Offline processing to consolidate memories, extract patterns, and evolve understanding — up to 14,400 learning cycles per day.",
  ...
  },
  {
    ...
    node: "ENCODE Agent",
    description: "Code generation, execution intelligence, and DECODE → ENCODE memory formation pipelines.",
  ...
  },
  {
    ...
    description: "Connect to enterprise systems with built-in LLM governance and adapter orchestration.",
  ...
  },
  {
    ...
    node: "INCLUSIVE Agent",
    description: "Human compatibility engine with WCAG 2.2 scanning, AI ethics enforcement, and auto-repair.",
