 ...
 * Homepage-centric, npm-focused hero section
 */
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-black tracking-tight text-foreground mb-4">
            Build on the <span className="text-primary">Substrate</span>
          </h2>
            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline" className={`text-[9px] ${TIER_COLORS[pkg.tier]}`}>
                    {pkg.tier}
                  </Badge>
                </div>
