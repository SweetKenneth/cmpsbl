        ...
        >
          ...
          <div className="text-center mb-4">
            <p className="text-sm text-muted-foreground">
              The 38-node matrix orchestrates intelligence across your application:
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {explanations.map((item) => (
              <div key={item.label} className="text-center p-3 rounded-lg border border-border/15 bg-card/30">
