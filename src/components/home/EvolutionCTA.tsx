          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 lg:gap-0">
            ...
            <div className="p-6 sm:p-10 lg:p-14 flex flex-col justify-center">
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/8 border border-primary/15 w-fit mb-6"
              >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3 mb-8">
                {pillars.map((p, i) => (
                  <motion.div
                    ...
                    className="flex flex-col items-center text-center p-3 rounded-xl bg-muted/30 border border-border/40 hover:border-primary/25 hover:bg-primary/[0.03] transition-all duration-300"
                  >
