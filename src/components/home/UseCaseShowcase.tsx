 ...
 const useCases = [
   {
     ...
     description: "Game characters with persistent memory that learn from player interactions across sessions.",
     industry: "Gaming",
   ...
   },
   {
     ...
     description: "Conversational AI that remembers every interaction, building deep context over time.",
   ...
   },
   {
     ...
     description: "Recipe apps that remember preferences, dietary restrictions, and adapt to your taste.",
     industry: "Consumer",
   ...
   },
   {
     ...
     description: "Operations that detect issues, learn patterns, and autonomously optimize workflows.",
     industry: "Enterprise",
   ...
   },
   {
     ...
     description: "Healthcare systems that track patient journeys and flag patterns across years.",
     industry: "Healthcare",
     color: "text-rose-500",
   ...
   },
   {
     ...
     description: "Critical systems that dream solutions, learning to fix failures before they cascade.",
     industry: "Aviation",
     color: "text-red-500",
       ...
       <div className="max-w-7xl mx-auto">
         ...
         >
           ...
           <p className="text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
             Real applications being built on CMPSBL v5.5.0 right now, and bold visions for what's possible next.
           </p>
         </motion.div>
