...
export function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 glass-panel border-b border-border/50 relative">
      {/* Memory Stream flowing accent bar */}
      <div className="absolute inset-x-0 top-0 h-[2px] memory-stream-bar z-10" />
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="gap-2 hover:bg-muted/50" aria-label="User menu">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-neon-blue flex items-center justify-center">
