...
const CATEGORY_LINKS: Record<string, { icon: React.ElementType; label: string; href: string; description: string }[]> = {
  insight: [
    ...
    { icon: Layers, label: 'Module Architecture', href: '/modules', description: 'Explore the 37-node substrate' },
  ],
  research: [
...
const DEFAULT_LINKS = [
  ...
  { icon: Layers, label: 'Platform Overview', href: '/modules', description: 'Explore the 37-node substrate' },
];
