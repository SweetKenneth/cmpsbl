...
const STEPS: AscensionStep[] = [
  ...
  },
  {
    ...
    body: 'Drop source files in any of 90+ supported languages — from TypeScript and Go to VHDL, CUDA, Solidity, and quantum computing languages.\n\nYour code becomes Primitive #41, a first‑class participant in the substrate matrix with its own capability surface.',
    bullets: ['90+ languages & extensions', 'HDL, GPU, blockchain, quantum, robotics', 'Your code is never stored or shared'],
    accent: 'neon-cyan',
