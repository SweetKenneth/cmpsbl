...
import { Zap, Play, Pause, RotateCcw, Activity, TrendingUp, Loader2, Trophy, Layers, Cpu, Trash2 } from 'lucide-react';
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-primary/10 border border-primary/20">
            ...
            <span className="text-[10px] text-muted-foreground">× 40 × 2-8 depth</span>
          </div>
          <span className="text-[9px] font-mono text-muted-foreground px-2 py-1 rounded bg-muted/20">
            Top {TOP_N} → Ascend
          </span>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {running ? (
            <Button size="sm" variant="destructive" onClick={stopDiscovery} className="h-10 min-h-[44px] text-xs gap-1.5 flex-1 sm:flex-none">
              <Pause className="w-4 h-4" /> Stop
            </Button>
          ) : (
            <Button size="sm" onClick={startDiscovery} className="h-10 min-h-[44px] text-xs gap-1.5 flex-1 sm:flex-none">
          ...
          <Button
            ...
            className="h-10 min-h-[44px] text-xs gap-1.5"
          >
