 ...
 * Uses opacity + pointer-events toggle instead of backfaceVisibility
    ...
    if (item.priceCents === 0) {
      ...
      try {
        ...
        await runWithCeremony(
          { itemName: item.name, kindLabel: isAgent ? "Meta-Agent" : "Engine",
          ...
          {!flipped ? (
            ...
            >
              ...
              <div className="relative z-10 px-5 sm:px-6 pb-5 sm:pb-6 -mt-8">
                ...
                <p className="text-xs sm:text-[13px] text-muted-foreground/70 leading-relaxed mt-3">{item.bio}</p>
