      ...
      <section className="container mx-auto px-4 mt-24 mb-8">
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          {[
            ...
            { q: 'What are industry vertical substrates?', a: 'Specialized 40-primitive environments for specific industries — Cyber, Fintech, Robotics, Media, Quantum, LLM, Agency, Health, Legal, Gaming, and Education. Each features domain-specific engines, agents, discoveries, and 89 Crown Jewels. All 12 verticals are fully active with themed homepages, seeded showrooms, and Crown Jewel registries.' },
            ...
            { q: 'Can I change my vertical selections?', a: 'Yes. Your vertical selections reset every billing cycle. After your monthly payment clears, you can choose new verticals for that period. Studio picks 3, Creator picks 6, and Architect gets all verticals automatically.' },
