/**
 * Desktop Command Center 2026
 * Full-featured desktop portal with split panels and sidebar
 */
...
import {
  ...
  Calendar, Activity, Command, Sparkles, Volume2, VolumeX
} from 'lucide-react';
    ...
    <div className={cn('flex flex-col h-full', className)}>
      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-border/30 bg-card/30 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <CollaborativeThinking agents={agentStates} />
