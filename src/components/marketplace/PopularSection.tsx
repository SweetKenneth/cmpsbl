...
export function PopularSection({ onPreview, onBuy, isLoading }: PopularSectionProps) {
  ...
  const sortedTemplates = (() => {
    switch (activeTab) {
      ...
      case 'new':
        // Return last 6 templates (assuming newer ones are at end of array)
              ...
              >
                <Card 
                  className={cn(
                    ...
                    index === 0 && activeTab === 'trending' && "ring-2 ring-orange-500/50"
                  )}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-3 text-xs text-muted-foreground">
                          <span className="flex items-center gap-1">
                            ...
                            {(templateStats as { view_count?: number }).view_count || 0}
                          </span>
                          <span className="flex items-center gap-1">
                            <Heart className="w-3 h-3" />
                            {(templateStats as { like_count?: number }).like_count || 0}
                          </span>
                          <span className="flex items-center gap-1">
                            <Download className="w-3 h-3" />
                            {(templateStats as { purchase_count?: number }).purchase_count || 0}
                          </span>
                        </div>
                      </div>
