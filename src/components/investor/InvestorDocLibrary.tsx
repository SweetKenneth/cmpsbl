  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "Every autonomous operation is logged to a tamper-evident Merkle chain. Every agent runs in a Convex Core™ artifact with source-blocked access. Every evolution candidate passes 7 validation gates. Every export is hex-encoded to protect IP. These aren't policies — they're architectural constraints that cannot be bypassed.",
      },
      {
    ...
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Meta-Agents (20 Convex Core™ Sealed Artifacts)", "Agent IP", "Source-blocked, versioned cognitive agents with 3–5 Crown Jewel powers each — Convex Core™ artifacts prevent extraction"],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["Agent & Engine Portfolio", "20 agents, 54 engines, Convex Core™ artifacts", "$3–7M", "Agent marketplace economics"],
