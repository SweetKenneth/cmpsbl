...
const INVESTOR_DOCS: InvestorDoc[] = [
  ...
  },
  {
    id: "demo-script",
    number: "10",
    title: "Ascension Demo Script",
    subtitle: "Step-by-step narration for live demonstrations",
    icon: <Cpu className="w-4 h-4" />,
    accentClass: "text-violet-600 border-violet-200 bg-violet-50",
    sections: [
      {
        heading: "Demo Overview",
        content: "The Ascension demo shows a basic script transforming into a production-ready, IP-protected software artifact — exported in any of 25 languages as a single file with zero dependencies. Total demo time: 2-3 minutes.",
      },
      {
        heading: "Demo Steps",
        table: {
          headers: ["Step", "Action", "What Investor Sees"],
          rows: [
            ["1", "Enter PIN (2026)", "PIN-gated access — security is structural"],
            ["2", "Select a discovered capability", "System found this autonomously via Memory Stream"],
            ["3", "Choose archetype classification", "CJPI scoring categorizes by novelty, utility, complexity"],
            ["4", "Select export language", "25 languages available — Python, Rust, Go, VHDL, etc."],
            ["5", "Generate Ascension artifact", "Single-file export with hex-encoded IP protection"],
            ["6", "Download and inspect", "Zero dependencies, runs standalone, IP protected"],
          ],
        },
      },
      {
        ...
        bullets: [
          "\"This capability was discovered by the system, not programmed by a human\"",
          "\"The export is a standalone product — it runs without CMPSBL\"",
          "\"All proprietary logic is hex-encoded — decompilation reveals nothing meaningful\"",
          "\"This is how we turn one platform into thousands of products\"",
          "\"Every export is a revenue event with near-zero marginal cost\"",
        ],
      },
    ],
  },
