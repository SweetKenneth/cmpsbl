...
export const DECODE_COMMANDS: CommandDefinition[] = [
  ...
  // Personality subsystem - interpretive filters only
...
export const VISION_COMMANDS: CommandDefinition[] = [
  { command: 'vision.status', description: 'Module status (Vee)', category: 'vision', icon: Eye, requiresOperator: false, requiredTier: 'free' },
...
export const EVOLUTION_CORE_COMMANDS: CommandDefinition[] = [
  ...
  { command: 'evolution.scan', description: 'Cognitive systems scan (4-phase: edge/system/health/LLM)', category: 'evolution', icon: Search, requiresOperator: true, requiredTier: 'architect', args: '[--explain|--llm-report|--dry-run]', example: 'evolution.scan --explain' },
  { command: 'evolution.circuit', description: 'Evolution circuit breaker control', category: 'evolution', icon: Shield, requiresOperator: false, requiredTier: 'free', args: '[status|reset|open <reason>]', example: 'evolution.circuit status' },
  { command: 'evolution.autonomy', description: 'Governed autonomy settings', category: 'evolution', icon: Settings, requiresOperator: true, requiredTier: 'architect', args: '[status|set <mode>]', example: 'evolution.autonomy set governed' },
  { command: 'evolution.receipts', description: 'List evolution receipts (audit trail)', category: 'evolution', icon: Database, requiresOperator: false, requiredTier: 'free', args: '[limit]' },
  { command: 'evolution.receipt', description: 'View specific evolution receipt', category: 'evolution', icon: Eye, requiresOperator: false, requiredTier: 'free', args: '<run_id>' },
  { command: 'evolution.verify', description: 'Eligibility gate (plan-independent)', category: 'evolution', icon: Shield, requiresOperator: false, requiredTier: 'free', args: '[component]', example: 'evolution.verify brain' },
  { command: 'evolution.analyze', description: 'Forward intent projection (what will change)', category: 'evolution', icon: Search, requiresOperator: false, requiredTier: 'free', args: '[component]', example: 'evolution.analyze memory' },
  { command: 'evolution.forensics', description: 'Historical truth (what has changed)', category: 'evolution', icon: Eye, requiresOperator: false, requiredTier: 'free', args: '<component> [--since 24h|7d|last_run]', example: 'evolution.forensics brain --since 24h' },
  { command: 'evolution.omega', description: 'Ω Unified observer v2.0 (can/will/has)', category: 'evolution', icon: Eye, requiresOperator: false, requiredTier: 'free', args: '[component] [--since 24h|7d|30d] [--compact]', example: 'evolution.omega brain --since 7d' },
  { command: 'evolution.plans', description: 'List active evolution plan', category: 'evolution', icon: Activity, requiresOperator: false, requiredTier: 'free' },
  { command: 'evolution.review', description: 'Review a specific plan', category: 'evolution', icon: Eye, requiresOperator: false, requiredTier: 'free', args: '<plan_id>' },
  { command: 'evolution.validate', description: 'Validate plan readiness', category: 'evolution', icon: Shield, requiresOperator: false, requiredTier: 'free', args: '<plan_id>' },
  { command: 'evolution.diff', description: 'View plan diff and health comparison', category: 'evolution', icon: Eye, requiresOperator: false, requiredTier: 'free', args: '<plan_id>' },
  { command: 'evolution.rollback', description: 'Rollback an applied plan', category: 'evolution', icon: Shield, requiresOperator: true, requiredTier: 'governor', args: '<plan_id>' },
  { command: 'evolution.delete', description: 'Delete/reject a plan', category: 'evolution', icon: Shield, requiresOperator: true, requiredTier: 'architect', args: '<plan_id>' },
  { command: 'evolution.applied', description: 'List all applied improvements', category: 'evolution', icon: Activity, requiresOperator: false, requiredTier: 'free' },
  { command: 'evolution.archived', description: 'Scan archived functions to repurpose', category: 'evolution', icon: Database, requiresOperator: false, requiredTier: 'free' },
  { command: 'evolution.implement', description: 'Generate code for archived function repurposing', category: 'evolution', icon: Sparkles, requiresOperator: true, requiredTier: 'governor', args: '<archived_function> <target_action>' },
  { command: 'evolution.export', description: 'Export job assets', category: 'evolution', icon: Database, requiresOperator: true, requiredTier: 'creator', args: '<job_id>' },
  { command: 'evolution.quota', description: 'Check usage limits', category: 'evolution', icon: Gauge, requiresOperator: false, requiredTier: 'free' },
  { command: 'evolution.refresh', description: 'Resync metrics and clear stale hints', category: 'evolution', icon: Activity, requiresOperator: true, requiredTier: 'creator' },
  { command: 'evolution.stamps', description: 'View evolution stamps for verification', category: 'evolution', icon: FileCheck, requiresOperator: false, requiredTier: 'free', args: '[limit]', example: 'evolution.stamps 5' },
];
...
// CLM (Constant Learning Mode) commands
...
// MODULE CLM — Module-specific self-learning
...
export const HARDENING_COMMANDS: CommandDefinition[] = [
  ...
  { command: 'system.hardening', description: 'SYSTEM hardening status (Bastion)', category: 'system', icon: Shield, requiresOperator: false, requiredTier: 'free' },
...
export const RIPPLE_HARDENING_COMMANDS: CommandDefinition[] = [
  { command: 'ripple.hardening', description: 'RIPPLE hardening status (Tsunami)', category: 'ripple', icon: Shield, requiresOperator: false, requiredTier: 'free' },
...
export const SANDBOX_HARDENING_COMMANDS: CommandDefinition[] = [
  { command: 'sandbox.hardening', description: 'SANDBOX hardening status (Crucible)', category: 'sandbox_mod', icon: Shield, requiresOperator: false, requiredTier: 'free' },
...
export const INCLUSIVE_HARDENING_COMMANDS: CommandDefinition[] = [
  { command: 'inclusive.hardening', description: 'INCLUSIVE hardening status (Clarity)', category: 'inclusive', icon: Shield, requiresOperator: false, requiredTier: 'free' },
...
export const COMMAND_CATEGORIES = {
  ...
  evolution: { label: 'EVOLUTION', color: 'text-pink-400', borderColor: 'border-pink-500/30', commands: EVOLUTION_CORE_COMMANDS },
