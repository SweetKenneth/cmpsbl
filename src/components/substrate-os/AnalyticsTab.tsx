        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: 'Intent Receipts', value: fmt(data.intentTotal), sub: `${data.intentAvgLatency}ms avg latency`, icon: GitBranch, iconColor: 'teal-400', border: 'border-teal-500/30', bg: 'from-teal-500/10 to-teal-500/5', iconBg: 'bg-teal-500/20 border-teal-500/40' },
