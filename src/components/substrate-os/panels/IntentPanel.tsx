...
function generateHubMessages(): HubMessage[] {
  const base: HubMessage[] = [
    ...
    { id: 'h21', source: 'RIPPLE', type: 'status', summary: 'Message bus throughput nominal — 1,240 events/min processed', detail: 'All 38 node subscriptions active. Average message latency: 3.2ms. No dropped messages in the last 6 hours. Queue depth: 0 (healthy).', urgency: 'low', age: '5m', status: 'acknowledged' },
    ...
    { id: 'h38', source: 'NERVE', type: 'status', summary: 'Inter-node communication matrix — all 38 nodes connected', detail: 'Full mesh connectivity confirmed. Average cross-node latency: 4.1ms. No partition events detected. Heartbeat failure count: 0 in last 24h.', urgency: 'low', age: '10m', status: 'acknowledged' },
