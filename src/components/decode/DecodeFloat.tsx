...
const MODE_GREETINGS: Record<DecodeMode, string> = {
  ...
  support: "Hey there 🛠️ — **DECODE** here, in **support mode**.\n\nI can help with accounts, billing, plan upgrades (**Free** → **Pro $29/mo**, or **Enterprise** by contract via /contact), Layer activation, vault limits, **Ascension v2** runs, **Mana** CLI install, and **NEXUS** routing.\n\nIf I can't sort it, I'll escalate you to a human at **support@cmpsbl.com**.",
      ...
      try {
        ...
        if (result) {
          ...
          if (result.source === 'restoration') {
            ...
            lookupReply = `✅ **Verified** — This is a **CLI Ascension** record.\n\n` +
              `**Fingerprint:** \`${s.fingerprint}\`\n` +
              `**CJPI:** ${cjpiDisplay}\n` +
              `**File:** ${s.fileName}\n` +
