          ...
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            ...
            {runCount > 0 && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] sm:text-xs font-mono text-muted-foreground">{runCount} queries executed</span>
              </div>
            )}
          </div>
        ...
        <div className="bg-card/30 border border-border/20 rounded-lg overflow-hidden backdrop-blur-sm">
          ...
          <div className="p-3 sm:p-4 min-h-[160px] sm:min-h-[200px] max-h-[400px] overflow-auto">
            {loading ? (
              ...
              <pre className="text-[10px] sm:text-xs font-mono text-foreground/80 whitespace-pre-wrap leading-relaxed">{result}</pre>
            ) : (
