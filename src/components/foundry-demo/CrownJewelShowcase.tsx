          ...
          {APEX_DISCOVERIES.map((discovery, i) => (
            ...
            >
              ...
              <div className="flex flex-wrap gap-1">
                ...
                <span className="text-[8px] sm:text-[9px] font-mono text-muted-foreground/30 flex items-center ml-1">
                  →
                </span>
                <span className="text-[8px] sm:text-[9px] font-mono px-1.5 py-0.5 rounded bg-primary/10 text-primary border border-primary/20">
                  PIPELINE
                </span>
              </div>
            </motion.div>
