...
const SDK_TEMPLATES = [
  ...
  { id: 'runtime-cjpi', name: 'CJPI Scoring', description: 'Memory chain scoring and auto-tiering via Convex Core™', category: 'runtime', tier: 'creator' as const, code: `import { score, classify } from '@cmpsbl/runtime';\n\n// Score a discovered memory chain\nconst cjpi = score({\n  novelty: 0.82,\n  utility: 0.91,\n  complexity: 0.65,\n  composability: 0.78\n});\n\n// Auto-classify tier\nconst tier = classify(cjpi);\nconsole.log(tier); // 'Prime' | 'Relic' | 'Mythic' | 'Apex'` },
