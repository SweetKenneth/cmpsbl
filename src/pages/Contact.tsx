          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12">
            ...
            <motion.div {...stagger(0.1)} id="contact-form" className="bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-xl shadow-primary/[0.03]">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button type="submit" disabled={isSubmitting} className="w-full bg-primary hover:bg-primary/90 h-12 text-base font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/30 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200">
