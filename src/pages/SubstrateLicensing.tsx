                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-muted-foreground mt-4 leading-relaxed">
                        It is <strong className="text-foreground">not an app or a plugin</strong> — it is the layer your models and agents run on. 14 specialized modules, 160,000+ lines of production code, solving AI behavioral drift at the infrastructure level.
                      </p>
                    </div>
                  </div>
                </CardContent>
