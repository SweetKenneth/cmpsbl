...
const TAXONOMY: TaxonomyCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'forge', label: 'FORGE', tagline: 'Artifact Synthesis', description: 'Manufacturing pipelines, artifact generation, hash-chain sealing, and IP protection.', icon: Hammer, slug: 'forge' },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: 'vision', label: 'VISION', tagline: 'Observer', description: 'Real-time surface health, request tracing, cost attribution, and predictive alerts.', icon: Eye, slug: 'vision' },
      ...
      { id: 'harvest', label: 'HARVEST', tagline: 'Collector', description: 'ETL pipelines, data ingestion, web crawling, and structured extraction.', icon: Wheat, slug: 'harvest' },
      ...
      { id: 'shadow', label: 'SHADOW', tagline: 'Divergence Tester', description: 'A/B testing, verdict comparison, shadow execution, and quality scoring.', icon: EyeOff, slug: 'shadow' },
    ],
  },
];
