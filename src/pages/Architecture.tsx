  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        keywords={['governed cognitive infrastructure', 'CMPSBL architecture', 'dual-layer technology', '40-primitive matrix', '40 primitives']}
        breadcrumbs={[
        ...
        faq={[
          ...
          { question: 'What is dual-layer technology?', answer: "CMPSBL's patented dual-layer architecture wraps your existing code (Legacy Host / Layer 1) with a governed cognitive infrastructure layer (Layer 2). Your code remains unchanged — Ascension scans and classifies, Mana attaches governance and defense." },
        ]}
      />
