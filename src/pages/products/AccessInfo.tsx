...
export default function AccessInfo() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        title="Access Console — Website Accessibility Compliance & WCAG Testing"
        description="Automated accessibility testing and compliance for WCAG 2.2, ADA, and Section 508. Scan websites, fix issues automatically, and earn verified accessibility badges."
        ...
        keywords={[
          ...
          'inclusive web design tool',
          'disability compliance testing'
        ]}
      />
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium">Access Console</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            and AI-powered fixes. Build inclusive digital experiences that reach all users.
          </p>
            ...
            {[
              {
                ...
                items: ["Color contrast ratios", "Text size and readability", "Focus indicators", "Visual hierarchy"]
              },
              {
                title: "Screen Reader Support",
                items: ["Alt text for images", "Proper heading structure", "ARIA labels", "Semantic HTML"]
              },
              {
                title: "Keyboard Navigation",
                items: ["Tab order and flow", "Skip navigation links", "Keyboard shortcuts", "Focus management"]
              },
              {
                title: "Form Accessibility",
                items: ["Input labels and instructions", "Error messaging", "Field validation", "Required field indicators"]
              },
              {
                title: "Multimedia Compliance",
                items: ["Video captions", "Audio descriptions", "Transcript availability", "Media player controls"]
              },
              {
                title: "Mobile Accessibility",
                items: ["Touch target sizes", "Gesture alternatives", "Responsive design", "Screen orientation support"]
              }
            ].map((category, index) => (
