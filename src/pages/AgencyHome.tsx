...
const AGENT_DATA: { id: string; name: string; desc: string; icon: LucideIcon }[] = [
  ...
  { id: "HERALD", name: "HERALD", desc: "Communication agent — progress reporting, result translation, expectation management, notification delivery", icon: Megaphone },
...
const CORE_COMPETENCIES = [
  ...
  { skill: "Professional Writing", primitive: "SCRIBE + HERALD" },
