...
export default function BurningItDown() {
  return (
    <>
      <SEO title="Burning It Down — The Complete Substrate Rebuild" description="In February 2026, we deleted thousands of lines of code and rebuilt the substrate from scratch. Here's why, and what we learned." type="article" publishedTime="2026-02-10" keywords={["substrate rebuild", "SPARTA epoch", "software refactoring", "technical debt elimination"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-origin" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Burning It Down", url: `https://cmpsbl.com/blog/${SLUG}` }]} />
      <BlogArticleJsonLd title="Burning It Down — The Complete Substrate Rebuild" description="Why we rebuilt the entire substrate from scratch in February 2026." slug={SLUG} datePublished="2026-02-10" imageUrl={heroImg} keywords={["SPARTA", "rebuild", "technical debt"]} />
      <PublicNav />
