...
export default function BurningItDown() {
  return (
    <BlogArticleLayout slug={SLUG} title="Burning It Down" subtitle="The complete substrate rebuild — the SPARTA epoch" date="February 10, 2026" readTime="20 min read" heroImage={heroImg} heroAlt="Substrate rebuild from scratch" chapter={19} showRewrittenNotice={false} head={<><SEO title="Burning It Down — The Complete Substrate Rebuild" description="In February 2026, we deleted thousands of lines of code and rebuilt the substrate from scratch. Here's why, and what we learned." type="article" image={heroImg} publishedTime="2026-02-10" keywords={["substrate rebuild", "SPARTA epoch", "software refactoring", "technical debt elimination"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-origin" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Burning It Down", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Burning It Down — The Complete Substrate Rebuild" description="Why we rebuilt the entire substrate from scratch in February 2026." slug={SLUG} datePublished="2026-02-10" imageUrl={heroImg} keywords={["SPARTA", "rebuild", "technical debt"]} /></>}>
      <p className="text-sm sm:text-base leading-relaxed">In February 2026, we did something that most startups would never do: we stopped shipping features and spent four weeks rebuilding the entire substrate from the ground up. We called it the SPARTA epoch, and it was the best decision we made.</p>

      <h2 className="text-2xl font-bold text-foreground mt-8">Why We Had to Rebuild</h2>
      <p>Fourteen months of rapid development since <Link to="/blog/the-first-line-of-code" className="text-primary hover:underline">the first line of code</Link> had left scars. Each node was built in isolation, with different conventions. Dependencies were tangled. <a href="https://martinfowler.com/bliki/TechnicalDebt.html" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">Technical debt</a> was compounding faster than feature development.</p>
      <p>The symptoms were clear. A simple change to NEXUS's routing logic required updating three other primitives that had hardcoded assumptions about NEXUS's response format. Adding a new field to BRAIN's memory schema broke <Link to="/blog/what-if-software-could-dream" className="text-primary hover:underline">DREAM's</Link> consolidation process because DREAM parsed BRAIN's output directly instead of through a shared interface. Deployment took 45 minutes because nodes had implicit ordering dependencies that nobody had documented. We were spending more time fighting the architecture than building on it.</p>
      ...
      <p>The rebuild introduced a formal <a href="https://en.wikipedia.org/wiki/Multitier_architecture" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">layer system</a>. Kernel primitives (CORTEX, <Link to="/blog/routing-the-unknown" className="text-primary hover:underline">NEXUS</Link>, <Link to="/blog/nodes-that-talk" className="text-primary hover:underline">RIPPLE</Link>) at the bottom — these never go down. Cognitive primitives (<Link to="/blog/teaching-machines-to-remember" className="text-primary hover:underline">BRAIN</Link>, <Link to="/blog/what-if-software-could-dream" className="text-primary hover:underline">DREAM</Link>, <Link to="/blog/when-software-starts-evolving" className="text-primary hover:underline">EVOLUTION</Link>) in the middle. Operational primitives (<Link to="/blog/when-bots-found-us-first" className="text-primary hover:underline">DEFENSE</Link>, <Link to="/blog/identity-at-every-layer" className="text-primary hover:underline">ACCESS</Link>, <Link to="/blog/seeing-everything-at-once" className="text-primary hover:underline">VISION</Link>) wrapping everything. Expansion primitives (<Link to="/blog/accessibility-is-infrastructure" className="text-primary hover:underline">INCLUSIVE</Link>, <Link to="/blog/protocols-for-machines" className="text-primary hover:underline">RELAY</Link>) at the edges.</p>
      ...
      <p>Technical debt is real debt. Pay it down before it pays you down. SPARTA wasn't a luxury — it was survival. We'd reached the point where adding any feature required modifying three other primitives, which introduced regressions, which required hotfixes, which introduced more debt. The rebuild broke that cycle. The <Link to="/blog/signal-to-silicon" className="text-primary hover:underline">complete system</Link> that followed would not have been possible without it.</p>
    </BlogArticleLayout>
  );
}
