...
export default function RoutingTheUnknown() {
  return (
    <BlogArticleLayout slug={SLUG} title="Routing the Unknown" subtitle="Building the NEXUS intelligent routing gateway" date="January 10, 2025" readTime="14 min read" heroImage={heroImg} heroAlt="NEXUS routing gateway architecture" chapter={2} showRewrittenNotice={false} head={<><SEO title="Routing the Unknown — Building the NEXUS Organ" description="How the NEXUS organ evolved from a simple failover function into an intelligent AI routing gateway with cost arbitrage and health-weighted selection." type="article" image={heroImg} publishedTime="2025-01-10" keywords={["AI routing gateway", "NEXUS organ", "multi-provider AI", "intelligent model selection", "cost arbitrage AI"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-primitives" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Routing the Unknown", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Routing the Unknown — Building the NEXUS Organ" description="How NEXUS evolved from failover into intelligent AI routing." slug={SLUG} datePublished="2025-01-10" imageUrl={heroImg} keywords={["NEXUS", "AI routing", "multi-provider"]} /></>}>
      ...
      <p>In January 2025, the AI provider landscape was fracturing. <a href="https://openai.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">OpenAI</a>, <a href="https://anthropic.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">Anthropic</a>, <a href="https://deepmind.google/technologies/gemini/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">Google Gemini</a>, <a href="https://mistral.ai" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">Mistral</a> — each had strengths. Claude was better at nuanced reasoning. GPT was faster for structured output. Gemini handled longer contexts. No single provider was best at everything.</p>
