    ...
    <>
      <SEO
        ...
        breadcrumbs={[
          ...
          { name: "Teaching Machines to Remember", url: `https://cmpsbl.com/blog/${SLUG}` },
        ]}
      />
      <BlogArticleJsonLd title="Teaching Machines to Remember — The BRAIN Node" description="Three-tier memory architecture for persistent AI recall." slug={SLUG} datePublished="2025-02-08" imageUrl={heroImg} keywords={["BRAIN node", "AI memory", "persistent recall"]} />
      <PublicNav />
        ...
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <figure className="my-8">
              <img src={imgTiers} alt="Three-tier memory architecture — hot, warm, and cold memory layers with decay and promotion" className="w-full rounded-xl aspect-video object-cover" loading="lazy" />
              <figcaption className="text-sm text-muted-foreground/70 mt-2 text-center">BRAIN's three-tier memory: hot (working), warm (recent), and cold (archive) — with automatic promotion and decay.</figcaption>
            </figure>
            ...
            <figure className="my-8">
              <img src={imgAdaptive} alt="Adaptive learning system adjusting memory retrieval based on usage patterns" className="w-full rounded-xl aspect-video object-cover" loading="lazy" />
              <figcaption className="text-sm text-muted-foreground/70 mt-2 text-center">BRAIN's adaptive retrieval system learns which memories matter most over time.</figcaption>
            </figure>
