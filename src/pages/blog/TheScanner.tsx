    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="text-muted-foreground mb-8">March 1, 2026 · 15 min read · Written by the CMPSBL team</p>
          <RewrittenNotice />
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <p>The combined pipeline is more than the sum of its parts. Some vulnerabilities are also accessibility issues — a form without CSRF protection is both a security risk and potentially inaccessible if the error handling fails silently. The Scanner identifies these overlaps and presents them as unified findings rather than duplicates. In our analysis, about 12% of findings have both security and accessibility dimensions. Presenting them together gives site owners a more accurate picture of their actual risk surface.</p>
            ...
            <p>The fix generation pipeline is sophisticated. For security findings, FORGE generates platform-specific fixes — a WordPress vulnerability gets a WordPress-specific patch, not generic guidance. For accessibility findings, FORGE generates the exact HTML/CSS/ARIA changes needed, targeted to the specific CMS or framework detected on the site. Fix accuracy (the percentage of generated fixes that resolve the finding without side effects) is currently 84% for security and 91% for accessibility. We're working to close the gap on security fix accuracy, which is lower because security patches have more potential for unintended interactions.</p>
