...
export default function InterfacesThatThink() {
  return (
    <BlogArticleLayout slug={SLUG} title="Interfaces That Think" subtitle="Dynamic, context-aware UI generation with FORGE" date="September 15, 2025" readTime="15 min read" heroImage={heroImg} heroAlt="FORGE adaptive interface generation" chapter={27} head={<><SEO title="Interfaces That Think — The FORGE Agent" description="FORGE generates and adapts interfaces based on context, capability, and user intent." type="article" image={heroImg} publishedTime="2025-09-15" keywords={["FORGE agent", "adaptive UI", "dynamic interfaces"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-primitives" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Interfaces That Think", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Interfaces That Think — The FORGE Agent" description="Dynamic, context-aware interface generation." slug={SLUG} datePublished="2025-09-15" imageUrl={heroImg} keywords={["FORGE", "adaptive UI", "dynamic"]} /></>}>
