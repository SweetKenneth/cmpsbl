...
export default function TheFirstLineOfCode() {
  return (
    ...
    >
      ...
      <p>The AI landscape at the time was clear in its limitations. You could call an API. You could get a response. But the moment the request ended, everything was gone. No memory. No learning. No continuity. Every interaction started from zero. The <a href="https://arxiv.org/abs/2307.03109" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">lost-in-the-middle</a> problem was well-documented — models couldn't even use what was in their context, let alone remember across sessions.</p>

      <p>We'd spent months watching teams duct-tape <a href="https://en.wikipedia.org/wiki/Retrieval-augmented_generation" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline"rel="noopener noreferrer">RAG pipelines</a> together that broke under load, and pay escalating costs for models that couldn't remember a conversation from five minutes ago. The tooling was impressive in isolation but architecturally bankrupt.</p>
