...
export default function NodesThatTalk() {
  return (
    <BlogArticleLayout slug={SLUG} title="Nodes That Talk" subtitle="Event-driven architecture with RIPPLE" date="April 2, 2025" readTime="12 min read" heroImage={heroImg} heroAlt="RIPPLE event bus architecture" chapter={6} showRewrittenNotice={false} head={<><SEO title="Nodes That Talk — Event-Driven Architecture" description="When five nodes needed to coordinate, point-to-point calls broke down. RIPPLE introduced pub/sub event propagation across the substrate." type="article" image={heroImg} publishedTime="2025-04-02" keywords={["event-driven AI", "RIPPLE organ", "pub/sub architecture", "inter-node communication"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-primitives" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Nodes That Talk", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Nodes That Talk — Event-Driven Architecture" description="Pub/sub event propagation across the substrate." slug={SLUG} datePublished="2025-04-02" imageUrl={heroImg} keywords={["RIPPLE", "event-driven", "pub/sub"]} /></>}>
      ...
      <p>RIPPLE transformed the substrate from a collection of tools into a coordinated system. Before RIPPLE, each node was an island. After RIPPLE, they were a network. That distinction matters more than any individual capability we built. It's the difference between having five hammers and having a hand.</p>
