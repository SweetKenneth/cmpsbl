...
export default function BreakingProblemsApart() {
  return (
    <BlogArticleLayout slug={SLUG} title="Breaking Problems Apart" subtitle="Automatic task decomposition and intelligent reassembly" date="April 8, 2025" readTime="15 min read" heroImage={heroImg} heroAlt="DECODE node decomposing complex tasks" chapter={22} head={<><SEO title="Breaking Problems Apart — The DECODE Node" description="Complex prompts fail. DECODE decomposes them into sub-tasks, routes each to the right model, and reassembles coherent responses." type="article" image={heroImg} publishedTime="2025-04-08" keywords={["DECODE node", "task decomposition", "prompt engineering"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-nodes" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Breaking Problems Apart", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Breaking Problems Apart — The DECODE Node" description="Task decomposition and intelligent reassembly." slug={SLUG} datePublished="2025-04-08" imageUrl={heroImg} keywords={["DECODE", "decomposition", "sub-tasks"]} /></>}>
