    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="text-muted-foreground mb-8">January 30, 2026 · 15 min read · Written by the CMPSBL team</p>
          <RewrittenNotice />
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <p>We built a "gaming mode" for the substrate that optimizes for latency above all else. In gaming mode, NEXUS routes to the fastest available model rather than the highest-quality one. BRAIN pre-loads NPC memory into an in-memory cache at session start. CASCADE is limited to two-stage pipelines maximum. PROOF runs a lighter validation pass. These trade-offs reduce quality by about 8% compared to enterprise mode but drop median latency from 1,200ms to 145ms. For gaming, that trade-off is non-negotiable.</p>
