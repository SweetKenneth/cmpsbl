...
export default function TheIntentLayer() {
  return (
    <BlogArticleLayout slug={SLUG} title="The Intent Layer" subtitle="Natural language to substrate operations via the Intent Mesh" date="November 20, 2025" readTime="17 min read" heroImage={heroImg} heroAlt="Intent Mesh routing natural language to substrate nodes" chapter={31} head={<><SEO title="The Intent Layer — Intent Mesh" description="The Intent Mesh translates natural language into substrate operations across any number of nodes." type="article" image={heroImg} publishedTime="2025-11-20" keywords={["Intent Mesh", "natural language routing", "semantic routing"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-nodes" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "The Intent Layer", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="The Intent Layer — Intent Mesh" description="Natural language to substrate operations." slug={SLUG} datePublished="2025-11-20" imageUrl={heroImg} keywords={["Intent Mesh", "NLU", "routing"]} /></>}>
