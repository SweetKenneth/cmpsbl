...
export default function TrustButVerify() {
  return (
    <BlogArticleLayout slug={SLUG} title="Trust But Verify" subtitle="Output validation, hallucination detection, and the PROOF engine" date="May 18, 2025" readTime="17 min read" heroImage={heroImg} heroAlt="PROOF engine validating AI outputs" chapter={23} head={<><SEO title="Trust But Verify — The PROOF Engine" description="AI outputs are probabilistic. PROOF validates them against constraints, catches hallucinations, and ensures quality thresholds." type="article" image={heroImg} publishedTime="2025-05-18" keywords={["PROOF engine", "AI validation", "hallucination detection"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-primitives" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Trust But Verify", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Trust But Verify — The PROOF Engine" description="Output validation and hallucination detection." slug={SLUG} datePublished="2025-05-18" imageUrl={heroImg} keywords={["PROOF", "validation", "hallucination"]} /></>}>
      <p className="text-sm sm:text-base leading-relaxed">In May, a customer's chatbot confidently told a user their refund had been processed. It hadn't. The model hallucinated a transaction ID. That was the week we built PROOF.</p>
