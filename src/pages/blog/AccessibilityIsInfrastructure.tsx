...
export default function AccessibilityIsInfrastructure() {
  return (
    <BlogArticleLayout slug={SLUG} title="Accessibility Is Infrastructure" subtitle="AI-powered scanning and remediation for every application" date="October 15, 2025" readTime="10 min read" heroImage={heroImg} heroAlt="INCLUSIVE node accessibility mission" chapter={15} showRewrittenNotice={false} head={<><SEO title="Accessibility Is Infrastructure — The INCLUSIVE Node" description="We built INCLUSIVE because accessibility shouldn't require a dedicated team. AI-powered scanning and remediation, available to every application." type="article" image={heroImg} publishedTime="2025-10-15" keywords={["AI accessibility", "INCLUSIVE node", "automated WCAG compliance", "accessibility remediation"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-nodes" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Accessibility Is Infrastructure", url: `https://cmpsbl.com/blog/${SLUG}` }]} /><BlogArticleJsonLd title="Accessibility Is Infrastructure — The INCLUSIVE Node" description="AI-powered accessibility scanning and remediation for every app." slug={SLUG} datePublished="2025-10-15" imageUrl={heroImg} keywords={["INCLUSIVE", "accessibility", "WCAG"]} /></>}>
