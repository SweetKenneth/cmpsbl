    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="text-muted-foreground mb-8">November 5, 2025 · 13 min read · Written by the CMPSBL team</p>
          <RewrittenNotice />
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            ...
            <p>We were watching the same pattern repeat across customer segments. Security teams deployed 4-6 related artifacts. Content teams deployed 3-5. Data teams deployed 5-8. Each time, they had to discover the artifacts individually, verify compatibility between them, and configure integrations manually. It was the <Link to="/blog/the-marketplace" className="text-primary hover:underline">Store</Link> working against itself — offering everything à la carte when most customers wanted the tasting menu.</p>
            ...
            <p>"Tested as a complete solution" means something specific. Every Pack goes through integration testing where all included artifacts are deployed together and exercised with realistic workloads. We verify that data flows correctly between artifacts, that there are no conflicting configurations, and that the combined output exceeds what any individual artifact produces. A Pack that doesn't deliver more value than the sum of its parts doesn't ship.</p>
            ...
            <p>Packs are designed to work together. The Security Pack and the Compliance Pack share data through standardized interfaces. The Content Pack feeds the Marketing Pack's distribution pipeline. We publish a compatibility matrix showing which Packs integrate natively and which require additional configuration. Over 60% of enterprise customers deploy two or more Packs, and cross-Pack data flows are the most frequently cited value driver in customer feedback.</p>
