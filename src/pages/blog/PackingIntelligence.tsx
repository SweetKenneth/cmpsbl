...
export default function PackingIntelligence() {
  return (
    ...
    >
      ...
      <p>Packs are cheaper than buying components individually — typically 30-40% savings. But the real value is in integration. Every capability in a Pack is pre-configured to work with every other capability in the same Pack. No glue code, no integration headaches.</p>

      <p>We ran the numbers on integration time savings. A customer deploying the Security Pack individually spent an average of 18 hours configuring capability integrations, testing data flows, and resolving compatibility issues. The Pack deployment takes 12 minutes. At typical consulting rates, the integration time savings alone exceed the Pack's annual cost. The 30-40% price discount is actually secondary to the time savings — but it's what customers ask about first.</p>
