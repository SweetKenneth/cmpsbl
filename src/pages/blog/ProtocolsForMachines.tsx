...
export default function ProtocolsForMachines() {
  return (
    <>
      <SEO title="Protocols for Machines — How AI Systems Should Talk" description="We adopted LLMs.txt, built machine-readable documentation, and established protocol standards for autonomous agent communication." type="article" image={heroImg} publishedTime="2025-12-05" keywords={["AI protocol standards", "LLMs.txt protocol", "machine-to-machine communication", "RELAY node"]} canonical={`https://cmpsbl.com/blog/${SLUG}`} topicCluster="substrate-protocols" breadcrumbs={[{ name: "Home", url: "https://cmpsbl.com" }, { name: "Blog", url: "https://cmpsbl.com/blog" }, { name: "Protocols for Machines", url: `https://cmpsbl.com/blog/${SLUG}` }]} />
