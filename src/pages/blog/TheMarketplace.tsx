    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <p className="text-muted-foreground mb-8">October 25, 2025 · 14 min read · Written by the CMPSBL team</p>
          <RewrittenNotice />
