...
export default function TheMarketplace() {
  return (
    ...
    >
      ...
      <p>The Store's architecture mirrors the substrate itself — it's built on substrate primitives. <Link to="/blog/mapping-what-we-built" className="text-primary hover:underline">ATLAS</Link> provides the capability taxonomy. <Link to="/blog/trust-but-verify" className="text-primary hover:underline">PROOF</Link> scores quality. <Link to="/blog/teaching-machines-to-remember" className="text-primary hover:underline">BRAIN</Link> powers the search and recommendation engine. Even the Store's UI is partially generated by <Link to="/blog/interfaces-that-think" className="text-primary hover:underline">MORPH</Link>. We eat our own cooking at every level.</p>
