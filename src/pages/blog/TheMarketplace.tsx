...
export default function TheMarketplace() {
  return (
    ...
    >
      ...
      <p>Nobody trusts AI-generated code sight unseen. The Store lets developers preview discovery outputs, inspect the generation process, and verify <Link to="/blog/trust-but-verify" className="text-primary hover:underline">PROOF scores</Link> before deploying. Transparency builds trust.</p>

      <p>The preview system goes deep. For code discoveries, developers can browse the full source, run tests in a sandbox, and inspect dependency trees. For report discoveries, they can preview the full document with sample data. For workflow discoveries, they can see the execution graph and estimated costs. Every discovery also shows its "lineage" — which nodes produced it, what inputs were used, and how many iterations were required. This level of transparency was a deliberate choice: in a world where AI-generated content is increasingly suspect, showing exactly how something was made is the strongest trust signal available.</p>
