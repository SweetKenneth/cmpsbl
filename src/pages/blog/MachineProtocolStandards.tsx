      ...
      <main className="min-h-screen bg-background">
        <article className="container max-w-3xl mx-auto px-4 py-16">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
            <p className="text-lg leading-relaxed">The v9.1.0 ARCHITECT Epoch introduces a fundamental shift in how autonomous systems communicate. With the RELAY and IDENTITY modules now part of the 21-module substrate, machine-to-machine protocol standards are no longer aspirational — they're enforced at runtime.</p>
