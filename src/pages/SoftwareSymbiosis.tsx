...
const CASE_STUDIES: { name: string; serial: string; lang: string; domain: string; badge: string; stat?: string; desc: string }[] = [
  ...
  { name: "Metasploit Exploit::Remote::Tcp", serial: "CMPSBL-MNJ5AB71-71MP", lang: "Ruby", domain: "Security", badge: "Stress Test", desc: "Penetration testing exploit primitive. Layer 2 attached GOVERNANCE hooks to network exploitation functions. Even adversarial tooling accepts the layer." },
