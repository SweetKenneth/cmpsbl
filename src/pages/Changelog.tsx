...
const stratumIronclad: Specimen[] = [
  ...
  },
  {
    ...
    phenotype: [
      "Primitives share insights laterally — a pattern discovered in MEMORY can strengthen BRAIN heuristics",
  ...
  },
  {
    ...
    origin: "survival",
    stimulus: "Primitives ran without containment — a single fault could cascade through the entire cognitive mesh",
    adaptations: [
...
const stratumSparta: Specimen[] = [
  {
    ...
    phenotype: [
      "Downstream primitives have full neural parity: embedding, recall, confidence classification, and drift detection",
  ...
  },
  {
    ...
    origin: "cognition",
    stimulus: "The substrate was generating significant learning volume but downstream primitives couldn't access any of it",
    adaptations: [
      "Knowledge transfer chain created: the parent learns, downstream primitives receive synthesized learnings automatically",
      "Periodic brain sync harvests high-value memories and distributes them to child primitives",
      "On-demand knowledge dumps available for initial bootstrapping of new primitives",
    ],
    phenotype: [
      "Downstream primitives receive brain learnings automatically without running their own learning cycles",
  ...
  },
  {
    ...
    fossilized: "2026-02-25",
    origin: "cognition",
    stimulus: "Dozens of high-value enhancement requests from primitives sat at 'pending' — the system was asking to improve but nothing was granted",
    adaptations: [
    ...
    phenotype: [
      ...
      "The substrate's own primitives requested improvements, and the substrate delivered",
      "Bidirectional feedback loop: primitives propose → substrate delivers → primitives acknowledge",
    ],
    affectedNodes: ["ALL PRIMITIVES"],
  },
  {
              ...
              <div className="relative mb-10">
                ...
                <div className="relative flex justify-center gap-2">
                   <div className={cn("px-6 py-2 rounded-full border text-sm font-mono tracking-wider", stratum.color, stratum.borderColor, "bg-background")}>
                    STRATUM {['I', 'II', 'III', 'IV', 'V', 'VI', 'VII'][stratumIdx]} — {stratum.epoch}
                  </div>
