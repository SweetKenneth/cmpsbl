  ...
  const concepts = [
    {
      ...
      description: "Each of our 14 modules operates as an independent cognitive unit. When combined, they create capabilities that emerge from their interaction — not just the sum of their parts."
    },
    {
      icon: GitMerge,
