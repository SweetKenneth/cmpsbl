...
const HUMAN_POSTS: BlogPost[] = [
  ...
  { id: 'ch32-architecture', title: "Forty Nodes Deep", excerpt: "From one function to forty interconnected nodes. A technical map of the complete substrate architecture and how it all fits together.", href: "/blog/thirty-eight-nodes-deep", category: "Technology", date: "2025-12-15", readTime: "18 min", image: ch32Img, imageAlt: "40-node architecture", source: 'human', featured: true, pillar: true, author: "CMPSBL Team", authorRole: "Platform Engineering" },
