          ...
          <div className="relative container mx-auto px-4 py-14 md:py-20 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-8">
                Written by <a href="https://orcid.org/0009-0001-4237-1243" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Kenneth E Sweet Jr</a> and generated by the CMPSBL Substrate.
