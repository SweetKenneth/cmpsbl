...
const HUMAN_POSTS: BlogPost[] = [
  {
    ...
    imageAlt: "Signal to Silicon journey", source: 'human', featured: true, pillar: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Software evolution breakthrough", source: 'human', featured: true, pillar: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    ...
    imageAlt: "AI protocol standards", source: 'human', featured: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    ...
    imageAlt: "AI governance and compliance", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Cognitive security evolution", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    ...
    imageAlt: "Bot attack defense in action", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    ...
    imageAlt: "Agents learning from experience", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
  ...
  },
  {
    ...
    imageAlt: "Agent memory fading over time", source: 'human', pillar: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    id: 'ch09-building', title: "Building on the Substrate",
    excerpt: "Eight primitives and no documentation. Making the substrate usable meant rethinking how developers interact with cognitive infrastructure.",
  ...
  },
  {
    ...
    excerpt: "When we couldn't debug our own system, we built VISION — real-time observability across every primitive, every request, every cost.",
    href: "/blog/seeing-everything-at-once", category: "Platform",
    date: "2025-03-20", readTime: "11 min", image: ch05Img,
    imageAlt: "VISION observability dashboard", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
    id: 'ch04-bots', title: "When Bots Found Us First",
    excerpt: "We didn't plan to build a security primitive. Then automated attacks found our API endpoints before we'd even launched.",
  ...
  },
  {
    ...
    excerpt: "How the NEXUS primitive evolved from a simple failover function into an intelligent AI routing gateway with cost optimization.",
    href: "/blog/routing-the-unknown", category: "Technology",
    date: "2025-01-10", readTime: "14 min", image: ch02Img,
    imageAlt: "NEXUS routing gateway architecture", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering",
  },
  {
  ...
  { id: 'ch27-morph', title: "Interfaces That Think", excerpt: "Static UIs can't keep up with cognitive systems. MORPH generates and adapts interfaces based on context, capability, and user intent.", href: "/blog/interfaces-that-think", category: "Technology", date: "2025-09-15", readTime: "11 min", image: ch27Img, imageAlt: "MORPH adaptive UI", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering" },
  { id: 'ch28-forge', title: "From Thought to Discovery", excerpt: "Ideas are cheap. FORGE turns substrate processing into downloadable, deployable software discoveries — scored, versioned, and ready to ship.", href: "/blog/from-thought-to-artifact", category: "Technology", date: "2025-10-08", readTime: "12 min", image: ch28Img, imageAlt: "FORGE discovery generation", source: 'human', author: "Kenneth Sweet", authorRole: "Substrate Engineering" },
  ...
  { id: 'ch31-intent', title: "The Intent Layer", excerpt: "Users say what they want, not how to get it. The Intent Mesh translates natural language into substrate operations across any number of primitives.", href: "/blog/the-intent-layer", category: "AI Technology", date: "2025-11-20", readTime: "13 min", image: ch31Img, imageAlt: "Intent Mesh", source: 'human', featured: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering" },
  { id: 'ch32-architecture', title: "The Full Architecture", excerpt: "From one function to a fully interconnected substrate. A technical map of the complete cognitive architecture and how it all fits together.", href: "/blog/thirty-eight-nodes-deep", category: "Technology", date: "2025-12-15", readTime: "18 min", image: ch32Img, imageAlt: "Substrate architecture map", source: 'human', featured: true, pillar: true, author: "Kenneth Sweet", authorRole: "Substrate Engineering" },
          ...
          <div className="relative container mx-auto px-4 py-14 md:py-20 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto mb-8">
                Written by the CMPSBL team and generated by our AI.
                Documenting what we're building and where the industry is headed.
              </p>
