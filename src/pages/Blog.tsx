    ...
    const fetchAutoPosts = async () => {
      ...
      if (data) {
        setAutoPosts(data.map(p => ({
          id: p.id,
          title: p.title,
          excerpt: p.excerpt || "AI-generated insight from the CMPSBL World Engine.",
          ...
          author: p.author_name || "CMPSBL World Engine",
          ...
          <div className="relative container mx-auto px-4 py-14 md:py-20 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-8">
                Written by Kenneth E Sweet Jr and generated by the CMPSBL World Engine.
