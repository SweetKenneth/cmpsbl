      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-5xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-muted-foreground">
            Part of the <strong>v9.3.0 ARCHITECT Three-Surface Standard Stack</strong>: Substrate · Governance · Machine Context
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="border-primary/30">
              <CardHeader>
                ...
                <CardDescription>
                  CMPSBL v9.3.0 ARCHITECT Epoch implementation
                </CardDescription>
              </CardHeader>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Card className="bg-muted/30">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Align with the v9.3.0 ARCHITECT standard for substrate-class systems.
                </p>
              </CardContent>
            </Card>
          </div>
