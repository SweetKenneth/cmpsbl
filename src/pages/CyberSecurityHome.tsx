...
function CyberNav() {
  return (
    <nav className="sticky top-0 z-50 border-b backdrop-blur-xl" style={{
      ...
      background: "hsl(220 30% 3% / 0.85)",
    }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Shield className="h-5 w-5" style={{ color: "hsl(0 85% 60%)" }} />
          <span className="font-bold text-sm tracking-wider">CMPSBL CYBER™</span>
        </div>
        <div className="hidden sm:flex items-center gap-6">
          <a href="https://cmpsbl.com" className="text-xs hover:underline" style={{ color: "hsl(220 15% 50%)" }}>
            CMPSBL.com
          </a>
          <Link to="/ascension" className="text-xs hover:underline" style={{ color: "hsl(220 15% 50%)" }}>
            Ascension
          </Link>
          <Link to="/showroom" className="text-xs hover:underline" style={{ color: "hsl(220 15% 50%)" }}>
            Scanners
          </Link>
          <Link to="/plans" className="text-xs hover:underline" style={{ color: "hsl(220 15% 50%)" }}>
            Plans
          </Link>
        </div>
        <Button
          ...
          onClick={() => window.location.href = '/ascension'}
        >
...
function CyberFooter() {
  return (
    <footer className="border-t" style={{ borderColor: "hsl(220 20% 10%)", background: "hsl(220 30% 3%)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <Shield className="h-4 w-4" style={{ color: "hsl(0 85% 60%)" }} />
              <span className="font-bold text-sm">CMPSBL CYBER™</span>
            </div>
            <p className="text-xs leading-relaxed" style={{ color: "hsl(220 15% 45%)" }}>
              Enterprise cognitive security infrastructure.
              A vertical substrate of CMPSBL® — Governed Cognitive Infrastructure by PromptFluid™.
            </p>
          </div>
          <div>
            <div className="text-xs font-bold mb-3" style={{ color: "hsl(220 15% 60%)" }}>SUBSTRATE</div>
            <div className="space-y-2">
              <Link to="/ascension" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>Security Audit</Link>
              <Link to="/showroom" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>Scanners</Link>
              <Link to="/plans" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>Plans</Link>
              <a href="https://cmpsbl.com" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>
                CMPSBL.com <ExternalLink className="inline h-3 w-3 ml-1" />
              </a>
            </div>
          </div>
          <div>
            <div className="text-xs font-bold mb-3" style={{ color: "hsl(220 15% 60%)" }}>PARENT</div>
            <div className="space-y-2">
              <a href="https://cmpsbl.com" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>CMPSBL® — Core Substrate</a>
              <a href="https://promptfluid.com" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>PromptFluid™ — Parent Company</a>
              <a href="https://cmpsbl.com/blog" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>Blog</a>
              <a href="https://cmpsbl.com/privacy" className="block text-xs hover:underline" style={{ color: "hsl(220 15% 45%)" }}>Privacy Policy</a>
            </div>
          </div>
        </div>
        <div className="pt-6 border-t flex flex-col sm:flex-row items-center justify-between gap-3" style={{ borderColor: "hsl(220 20% 10%)" }}>
          <p className="text-xs" style={{ color: "hsl(220 15% 35%)" }}>
            © {new Date().getFullYear()} CMPSBL® · PromptFluid™ · All rights reserved.
          </p>
          <p className="text-xs" style={{ color: "hsl(220 15% 30%)" }}>
            security.cmpsbl.com · Vertical Cognitive Infrastructure
          </p>
        </div>
      </div>
    </footer>
