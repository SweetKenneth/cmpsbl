...
const MODULE_COLORS: Record<ModuleName, string> = {
  ...
  access: 'from-neon-amber/20 to-orange-600/5 border-neon-amber/30',
  inclusive: 'from-neon-magenta/20 to-pink-600/5 border-neon-magenta/30',
  ...
  encode: 'from-neon-amber/20 to-yellow-600/5 border-neon-amber/30',
  ...
  economy: 'from-neon-amber/20 to-amber-700/5 border-neon-amber/30',
  sandbox: 'from-neon-cyan/20 to-teal-600/5 border-neon-cyan/30',
  ...
  oracle: 'from-neon-purple/20 to-purple-700/5 border-neon-purple/30',
  ...
  compass: 'from-neon-green/20 to-green-700/5 border-neon-green/30',
  echo: 'from-neon-blue/20 to-blue-700/5 border-neon-blue/30',
  reflex: 'from-destructive/20 to-red-700/5 border-destructive/30',
  forge: 'from-neon-amber/20 to-neon-amber/5 border-neon-amber/30',
  lingua: 'from-primary/20 to-indigo-700/5 border-primary/30',
  harvest: 'from-lime-600/20 to-lime-700/5 border-lime-600/30',
  phantom: 'from-gray-600/20 to-gray-700/5 border-gray-600/30',
  evolution: 'from-neon-green/20 to-emerald-700/5 border-neon-green/30',
  shadow: 'from-slate-600/20 to-slate-700/5 border-slate-600/30',
  immunity: 'from-neon-magenta/20 to-rose-700/5 border-neon-magenta/30',
  intent: 'from-neon-purple/20 to-violet-700/5 border-neon-purple/30',
