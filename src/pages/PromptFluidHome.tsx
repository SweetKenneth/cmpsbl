            ...
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed text-base sm:text-lg">
                  CMPSBL® is a cognitive infrastructure substrate with 40 Primitives across 4 categories (Organs, Layers, Engines, Agents) spanning 200,000+ lines of production code. 
                  We focus on persistent memory architectures, autonomous self-evolution, and model-agnostic AI routing. 
                  CMPSBL serves as the canonical architecture and technical foundation for all substrate development.
                </p>
