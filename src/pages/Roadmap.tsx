...
const PHASES = [
  ...
  },
  {
    ...
    status: "Shipped",
    description: "The commercial model is live. Two-plan subscription (Free forever and Pro $29/mo), Showroom artifact sales with CJPI-based pricing, Stripe checkout, and the npm package ecosystem are all operational. Enterprise is offered by contract.",
    capabilities: [
      "Free + Pro plans (collapsed from earlier 4-tier ladder in v19.1)",
      "Showroom marketplace with 100-item static collections",
      "Graduated CJPI economy (Mint → Prime → Relic → Mythic → Apex)",
      "Stripe integration for Pro subscriptions and one-off Store purchases",
