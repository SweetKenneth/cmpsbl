      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Link to="/plans" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-border text-foreground font-medium hover:bg-secondary transition-colors">
              View Plans
            </Link>
          </div>
        </motion.div>
...
function MemoryStreamSection() {
  const phases = [
    ...
    { icon: Code2, label: 'Software Export', desc: 'Crystallized memories export to 90+ languages as self-contained single-file distributions with built-in runtime and test harness.', color: 'text-neon-green' },
...
export default function SystemOverview() {
  return (
    <>
      <Helmet>
        <title>System Overview — 40-Primitive AI Substrate | CMPSBL®</title>
