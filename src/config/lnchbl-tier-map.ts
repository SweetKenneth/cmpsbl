...
export const FREE_CAPABILITIES: TieredCapability[] = [
  ...
  { id: 'audio_experience_engine', name: 'Audio Experience Engine', tier: 'free', category: 'experience', description: 'Voice and audio processing memory chain' },
...
export const BUILDER_CAPABILITIES: TieredCapability[] = [
  ...
  { id: 'brain_transfer', name: 'Brain Transfer Memory Chain', tier: 'builder', category: 'intelligence', description: 'Distill memories into module heuristics' },
