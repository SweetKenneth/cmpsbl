...
export const adminNavConfig: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "devtools", label: "Developer Tools", path: "/devtools", icon: Terminal },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "pricing", label: "Upgrade", path: "/plans", icon: Gauge },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "vertical-factory", label: "Vertical Factory", path: "/admin/vertical-factory", icon: Cpu, isNew: true },
