...
export const routeRegistry: RouteEntry[] = [
  ...
  { path: "/upgrade", label: "Upgrade", section: "product", priority: 0.88, changefreq: "monthly", description: "Plans & pricing tiers" },
  ...
  { path: "/feed-dream-eater", label: "Dream Feeder", section: "product", priority: 0.82, changefreq: "daily", description: "Feed the DREAM consolidation engine" },
  ...
  { path: "/proof", label: "Proof Mode", section: "product", priority: 0.80, changefreq: "monthly", description: "Provenance & audit verification" },
  ...
  { path: "/clockless-world-engine", label: "Clockless World Engine", section: "product", priority: 0.72, changefreq: "monthly", description: "Time-independent world simulation" },
  { path: "/scan", label: "Scanner", section: "product", priority: 0.72, changefreq: "monthly", description: "Accessibility & security scanner" },
  { path: "/scanner", label: "Scanner Tool", section: "product", priority: 0.72, changefreq: "monthly", description: "Domain scanning tool" },
