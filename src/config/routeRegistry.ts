...
export const routeRegistry: RouteEntry[] = [
  ...
  { path: "/restoration-shop", label: "Ascension Lab", section: "product", priority: 0.80, changefreq: "monthly", description: "Professional code diagnostic and certified ascension" },
  ...
  { path: "/devtools", label: "Developer Tools", section: "developer", priority: 0.75, changefreq: "monthly", description: "Development tools" },
