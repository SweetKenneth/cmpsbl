...
export const routeRegistry: RouteEntry[] = [
  ...
  { path: "/modules", label: "Architecture", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  ...
  { path: "/lies", label: "Lies", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/dreams", label: "Dreams", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/try", label: "Try It", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/genesis", label: "Genesis", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/memory-stream", label: "Memory Stream Alias", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/forge", label: "Forge Alias", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/sdk-playground", label: "SDK Playground", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/solutions", label: "Solutions Alias", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/projects", label: "Projects Alias", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/engines", label: "Engines List", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/agents", label: "Agents List", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/composable-cognitives", label: "Composable Cognitives", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/beta", label: "Beta", section: "core", priority: 0, changefreq: "monthly", redirect: true },
  ...
  { path: "/foundry", label: "Memory Stream", section: "product", priority: 0.60, changefreq: "weekly", description: "Discover & crystallize memory pipelines" },
  ...
  { path: "/dream-eater/archaeology", label: "Dream Archaeology", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/dream-eater/artifacts", label: "Dream Artifacts", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  ...
  { path: "/showcase", label: "Showcase", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/intent-mesh", label: "Intent Mesh", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  ...
  { path: "/restoration-shop", label: "Ascension Lab", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/agent-forge", label: "Agent Forge", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/agent-power-up", label: "Agent Power-Up", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/investor-showcase", label: "Investor Showcase", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  ...
  { path: "/api-access", label: "API Access — Developer Hub", section: "developer", priority: 0.95, changefreq: "weekly", description: "Free API key + docs + SDK — one endpoint, 40 primitives" },
  { path: "/workspace", label: "Builder Workspace", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/codelab", label: "Developers Playground", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/academy", label: "Academy", section: "developer", priority: 0.78, changefreq: "monthly", description: "Tutorials, learning tracks & certification" },
  { path: "/developers", label: "Developer Showcase", section: "protected", priority: 0, changefreq: "monthly", disallow: true, redirect: true },
  { path: "/developers/guide", label: "Developer Guide", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  { path: "/devtools", label: "Developer Tools", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  ...
  { path: "/lab", label: "Lab", section: "protected", priority: 0, changefreq: "monthly", disallow: true },
  ...
  { path: "/solutions", label: "Solutions", section: "company", priority: 0, changefreq: "monthly", redirect: true },
  ...
  { path: "/careers", label: "Careers", section: "company", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/projects", label: "Current Projects", section: "company", priority: 0, changefreq: "monthly", redirect: true },
  ...
  { path: "/promptfluid", label: "PromptFluid", section: "company", priority: 0, changefreq: "monthly", redirect: true },
  { path: "/software-symbiosis", label: "Software Symbiosis", section: "company", priority: 0.55, changefreq: "monthly", description: "Vision: human + machine symbiosis" },
