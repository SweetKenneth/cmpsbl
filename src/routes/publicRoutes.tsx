...
const ManaDistributionDoc = lazy(() => import("@/pages/ManaDistributionDoc"));
...
export const publicRoutes = (
  <>
    ...
    <Route path="/investor-showcase" element={<Navigate to="/auth?redirect=/investor-showcase-private" replace />} />
    <Route path="/investor-showcase-private" element={<InvestorShowcase />} />
