...
// Initialize analytics before app bootstrap
initPostHog();
...
import { VerticalThemeWrapper } from "@/components/theme/VerticalThemeWrapper";
...
import { DeferredDecodeFloat } from "@/components/decode/DeferredDecodeFloat";
                ...
                <VerticalThemeWrapper>
                  ...
                  <SonnerToaster />
                   <BrowserRouter>
                    ...
                    <div className="w-full bg-amber-500/90 text-black text-center py-2 px-4 text-sm font-medium z-[9999] relative">
