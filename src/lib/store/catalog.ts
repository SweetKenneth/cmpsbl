...
const STORE_ENGINES: StoreItem[] = [
  ...
  },
  {
    ...
    description: "Mini-CORTEX provides multi-agent task delegation, cognitive load balancing, shared memory coordination, agent competency tracking, automatic skill routing, and collaborative reasoning.",
    image: cortexImg,
    icon: Brain,
    tier: "pro",
    priceCents: 12900,
  ...
  },
  {
    ...
    description: "Mini-NEXUS provides real-time model selection, cost-aware provider optimization, latency-based failover, response quality scoring, token budget management, and multi-provider load balancing.",
    image: nexusImg,
    icon: Network,
    tier: "elite",
    priceCents: 15900,
  ...
  },
  {
    ...
    bio: "Orchestrates all 8 core pipelines into a single Convex Core™ artifact. Parse, Route, Execute, Heal, Defend, Learn, Observe, Audit — one import.",
