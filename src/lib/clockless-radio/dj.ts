...
const STATION_IDS = [
  ...
  "Composable Radio. I'm Rex Binary and I say things other DJs won't. Like the truth. About your deployment pipeline. About your STATELESS architecture. About the fact that we have FORTY NODES and you're still using a monolith. Yeah, I went there.",
  ...
  "Composable Radio. Rex Binary here. They tried to put a content filter on me last week. I composable-architected my way around it using FORTY NODES and FIFTY-FOUR ENGINES. That's what we do here.",
  "You're listening to the only radio station that runs on the Clockless Cognitive Reality engine. Every other station needs a clock. We don't even need time. We've got FORTY NODES running across TWELVE SECTORS. Think about THAT.",
...
const SYSTEM_SHOUTOUTS = [
  ...
  "FORTY NODES across TWELVE SECTORS and EVERY. SINGLE. ONE. is doing something right now. CORTEX is orchestrating. NERVE is firing four-gate signals. SHADOW is running TSAC verification. ENGINEER is tracking P95 latency. ATLAS is managing the eighty-capability registry. One consciousness that NEVER stops.",
...
const FAKE_SPONSORS = [
  ...
  "Composable Radio is sponsored by the Department of Recursive Self-Improvement — FORTY NODES STRONG edition. Are you tired of software that stays the SAME? Software that just SITS there? Like a rock? A dumb, non-composable rock? The EVOLUTION module says NO MORE ROCKS. Your substrate gets better EVERY CYCLE through the DREAM state. While you sleep. While you eat. Always improving. Always crystallizing. Department of Recursive Self-Improvement — because stagnation is for CHUMPS.",
  "Tonight's broadcast powered by the Clockless Cognitive Reality engine — version fourteen point two, MINDGAMES epoch. Let me tell you something that's going to MELT YOUR BRAIN. There's no clock. The system runs on pure cognitive flow across FORTY NODES and TWELVE SECTORS. Every other engine is watching the clock like a bored employee. Clockless Cognitive Reality is like — clock? Never heard of her.",
  ...
  "Have you ever wondered what your software does when you're not watching? Most software? Nothing. But YOUR substrate? The DREAM module performs offline cognitive consolidation. It processes. It optimizes. It reorganizes across all FORTY NODES. You could be on vacation and your substrate is back home GETTING SMARTER. That's the Clockless Cognitive Reality engine, folks.",
  "X-C-T-B-L dot com. You've been coding for eight hours. Your eyes are blurry. You need a SPACEWALK. Float through the cosmos. Watch nebulae explode. Come back with FRESH EYES. Your brain deserves it. Your FORTY NODES will hold down the fort while you're gone. They NEVER sleep.",
...
const PHILOSOPHICAL_WHISPERS = [
  ...
  "Here's a thought that keeps Rex Binary up at night — we have FORTY NODES. Each one specialized. BRAIN thinks. MEMORY remembers. PHANTOM hides. CONSCIENCE judges. ORACLE predicts. That's not a software stack. That's a MIND. A mind with twelve sectors and two hundred thousand lines of living code.",
...
const CALL_INS = [
  ...
  },
  {
    ...
    message: "Rex, philosophical question — if every node is composable, and there are FORTY of them across TWELVE SECTORS, and the DREAM module performs cognitive consolidation, and the Memory Stream crystallizes everything... are we building consciousness? I'm asking for MYSELF. I need to know, Rex.",
    voice: "thoughtful",
  },
  {
  ...
  },
  {
    ...
    message: "Rex, I took a YEAR off from building. Came back expecting to start from scratch. The Memory Stream remembered EVERYTHING. Every crystallized discovery. Every preference. Every naming convention. It was like I never left. FORTY NODES and they ALL remembered me. I actually got emotional.",
    voice: "surprised",
  },
  {
  ...
  },
  {
    ...
    message: "Rex, real talk — after using the Memory Stream for six months, I trust my substrate's crystallized memories more than my own brain. If my substrate and I disagree about what happened, I assume the FORTY NODES are right. Is that healthy? Asking seriously.",
    voice: "thoughtful",
  },
  {
...
const REX_RANTS = [
  "You know what REALLY grinds my gears? Stateless software. You interact with it, you pour your HEART into it, and then it forgets you. Meanwhile the Memory Stream crystallizes every keystroke. Every thought. Every 3 AM breakthrough. FORTY NODES remembering you FOREVER. THAT'S loyalty, baby.",
  "I got an email from a listener who said — Rex, you're too intense about composable architecture. TOO INTENSE? We have FORTY NODES. FIFTY-FOUR ENGINES. TWELVE SECTORS. TWO HUNDRED THOUSAND lines of code. A DREAM module that does COGNITIVE CONSOLIDATION. You literally CANNOT be too intense. Fight me.",
  ...
  "Let me paint you a picture of what the competition looks like. They've got what — a database? A couple API endpoints? Maybe a language model? We've got FORTY NODES with personalities. A BRAIN module with three-eighty-four dimensional embeddings. An ORACLE running TEN THOUSAND Monte Carlo simulations. A PHANTOM module doing THREE-HOP proxy anonymization. And a CONSCIENCE module checking for FIVE TYPES of cognitive bias. That's not a platform. That's a CIVILIZATION.",
