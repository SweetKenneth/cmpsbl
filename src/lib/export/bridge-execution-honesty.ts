...
const SERVER_REQUIREMENTS: Record<string, string> = {
  ...
  erlang: 'OTP 26+ (rebar3 or escript)',
  lua: 'Lua 5.4+ or LuaJIT runtime',
  dart: 'Dart 3.0+ SDK',
  scala: 'Scala 3 + sbt (JVM-based)',
  haskell: 'GHC 9.4+ / Stack',
  nim: 'Nim 2.0+ compiler',
  crystal: 'Crystal 1.9+ compiler',
  d: 'DMD or LDC D compiler',
  julia: 'Julia 1.9+ runtime',
  r: 'R 4.3+ (Rscript)',
  perl: 'Perl 5.36+ runtime',
  ocaml: 'OCaml 5.0+ / opam',
  fsharp: '.NET 8+ (dotnet fsi)',
  clojure: 'Clojure 1.11+ / Leiningen or deps.edn',
  groovy: 'Groovy 4.0+ / JVM',
  fortran: 'gfortran 13+ or Intel Fortran',
  'objective-c': 'Clang / Xcode toolchain',
  bash: 'Bash 5.0+ shell',
  powershell: 'PowerShell 7.3+ (pwsh)',
  // Blockchain
  solidity: 'Solc 0.8.20+ (Foundry or Hardhat)',
  vyper: 'Vyper 0.3.9+ compiler',
  move: 'Aptos CLI or Sui Move',
  cairo: 'Scarb / Cairo 2.x compiler',
  // GPU / Shaders
  cuda: 'NVIDIA CUDA Toolkit 12+',
  glsl: 'glslangValidator (Vulkan SDK)',
  hlsl: 'DirectX Shader Compiler (dxc)',
  wgsl: 'Naga / wgpu validator',
  metal: 'Xcode Metal compiler (xcrun)',
  opencl: 'OpenCL runtime + headers',
  // HDL
  vhdl: 'GHDL simulator',
  ...
  firrtl: 'FIRRTL compiler (Chisel toolchain)',
  bluespec: 'Bluespec compiler (bsc)',
};
