...
function generateLicenseHTML(pipelineName: string): string {
...
<head>
  ...
  <title>License — ${esc(pipelineName)}</title>
  <style>
...
<div class="page">
  ...
  <div class="license-header">
    ...
    <div class="license-title">Commercial Distribution License</div>
    <div class="license-subtitle">Governing the use, modification, and distribution of exported pipeline software</div>
  </div>
  ...
  <p style="text-align: center; font-size: 0.82rem; color: #6b6b78; margin-bottom: 2rem;">
    Issued ${date} for <strong style="color: #1a1a1f;">${esc(pipelineName)}</strong>
  </p>
