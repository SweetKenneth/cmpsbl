...
function header(a: ExportableArtifact, lang: string, comment: string): string {
  ...
  return [
    `${comment} ════════════════════════════════════════════════════════`,
    `${comment} CMPSBL® Capability — ${a.name}`,
...
module ${mod} #(
    ...
    // ─── Provenance (metadata — not used in synthesis logic) ──
    // Crown Jewel: ${a.name}
    // Rank: #${a.rank} | Module: ${a.module}
...
class ${cls}(config: ${cls}Config = new ${cls}Config()) extends Module {
  ...
  // Provenance: ${a.name} | Rank #${a.rank} | Module: ${a.module}
}
...
.TITLE ${a.name} — Rank #${a.rank} | Module: ${a.module}
...
${pipelineLogic}
    ...
    void print_info() {
        ...
        std::cout << "  Rank: #${a.rank} | Module: ${a.module}" << std::endl;
