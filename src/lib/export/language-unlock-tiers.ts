...
export const LANGUAGE_UNLOCK_TIERS: LanguageUnlockTier[] = [
  ...
  },
  {
    ...
    label: 'Prime',
    minScore: 80,
    languages: ['typescript', 'python', 'go', 'java', 'csharp', 'fsharp', 'r', 'julia', 'objective-c', 'fortran', 'd'],
  ...
  },
  {
    ...
    label: 'Relic',
    minScore: 90,
    languages: ['rust', 'c', 'cpp', 'zig', 'scala', 'haskell', 'elixir', 'erlang', 'ocaml', 'clojure', 'nim', 'crystal', 'solidity', 'vyper', 'move', 'cairo'],
    description: 'Systems, functional & blockchain languages — unlocked at Relic tier (90+)',
  },
  {
    id: 'silicon',
    label: 'Silicon',
    minScore: 94,
    languages: ['verilog', 'vhdl', 'systemverilog', 'chisel', 'amaranth', 'spice', 'systemc', 'firrtl', 'bluespec', 'cuda', 'glsl', 'hlsl', 'wgsl', 'metal', 'opencl'],
    description: 'Hardware / HDL / GPU targets — Mythic+ only (94+)',
  },
];
