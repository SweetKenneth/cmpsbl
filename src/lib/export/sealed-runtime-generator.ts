...
export function generateSealedRuntimeReadme(): string {
  return [
    ...
    '',
    'This is a **sealed build** of the CMPSBL® Mini-Runtime™ Engine.',
    'Internal algorithms, scoring weights, and discovery templates are protected.',
    '',
    '## Included Components',
    '',
    '- **standalone-runtime.ts** — Sealed Mini-Runtime™: CJPI scoring, state machine, pipeline orchestration',
    '- **standalone-discovery-engine.ts** — Sealed Discovery Engine: user-template execution only',
    ...
    '- Discovery synthesis templates (37 built-in patterns)',
    '- Module effect deep implementations (40-node matrix)',
    '- Synergy multiplier formulas',
    '- Memory Stream integration logic',
    '',
    '## Full Capabilities',
    '',
    'For unrestricted discovery and deep module effects, use the',
