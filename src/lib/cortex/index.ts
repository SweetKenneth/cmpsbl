...
export const MODULE_REGISTRY: Record<SubstrateModule, Omit<ModuleRegistryEntry, 'health' | 'circuitState' | 'lastPing'>> = {
  ...
  defense: { module: 'defense', layer: 'operational', bootOrder: 9, dependencies: ['access'] },
  nexus: { module: 'nexus', layer: 'cognitive', bootOrder: 10, dependencies: ['defense'] },
  dream: { module: 'dream', layer: 'cognitive', bootOrder: 11, dependencies: ['nexus'] },
