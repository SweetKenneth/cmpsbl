...
1. **Everything is built into one file** — Convex Core™, Module Effects, Pipeline Bridge are all embedded. No external runtime to install.
...
- **§1 Convex Core™** — CJPI scorer, Saga orchestrator, FSM engine, manifest parser, fingerprinting (BUILT-IN)
...
> ⚠️ The Convex Core™ is a sealed proprietary component embedded in this file.
...
Convex Core™ Processing Layer in your own projects.
...
4. The Convex Core™ Processing Layer is a sealed proprietary component.
