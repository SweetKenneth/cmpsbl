...
const WORLD_FIRSTS = [
  ...
  { achievement: "Intent Mesh", description: "First emergent capability discovery system where modules advertise, compose, and crystallize cross-module pipelines autonomously", evidence: "50 crystallized Crown Jewel pipelines" },
...
<div class="page">
  ...
  <table>
    ...
    <tbody>
      <tr><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--text);font-weight:600;">Master Substrate SaaS</td><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--text-muted);">Monthly subscriptions (Free → $149/mo)</td><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--emerald);">90%+</td></tr>
      <tr><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--text);font-weight:600;">Infrastructure Licensing</td><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--text-muted);">Via LNCHBL.com (Free → Enterprise)</td><td style="padding:12px 16px;border-bottom:1px solid var(--border);color:var(--emerald);">90%+</td></tr>
...
<div class="page">
  ...
  <ul class="checklist">
    ...
    <li>Intent Mesh distributed resolution (60+ pipelines)</li>
