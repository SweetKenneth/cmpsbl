...
const WORLD_FIRSTS = [
  ...
  { achievement: "Intent Mesh", description: "First emergent capability discovery system where modules advertise, compose, and crystallize cross-module pipelines autonomously", evidence: "60+ crystallized pipelines" },
