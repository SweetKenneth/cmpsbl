...
export const TIERED_COMMANDS: TieredCommand[] = [
  ...
  { command: 'foundry crystallize', description: 'Crystallize a pipeline from the Memory Stream', tier: 'free', category: 'build' },
  { command: 'foundry vault', description: 'View your crystallized pipeline inventory', tier: 'free', category: 'build' },
