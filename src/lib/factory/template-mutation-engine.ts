...
const VERTICAL_POOLS: Record<string, string[]> = {
  ...
  fintech: [...SPINE, 'LEDGER', 'VAULT_FIN', 'TICKER', 'CLEARING', 'RISKCORE', 'PAYRAIL', 'TAXENGINE', 'MATCHBOOK', 'SENTINEL_FIN', 'REGULATOR', 'ARBITER', 'UNDERWRITER', 'TREASURER', 'AUDITOR', 'PORTFOLIO', 'COMPLIANCE'],
  ultimate: [
    ...SPINE,
    ...
    'LEDGER', 'VAULT_FIN', 'TICKER', 'CLEARING', 'RISKCORE', 'PAYRAIL', 'TAXENGINE', 'MATCHBOOK', 'SENTINEL_FIN', 'REGULATOR', 'ARBITER', 'UNDERWRITER', 'TREASURER', 'AUDITOR', 'PORTFOLIO', 'COMPLIANCE',
  ],
};
