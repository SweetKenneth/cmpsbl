...
const QUANTUM_ENGINES: VerticalPrimitive[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      'quantum_volume_estimation',
      'transpilation_pass_optimization',
      'decoherence_aware_scheduling',
      'surface_code_decoding',
    ],
    weight: 0.030,
    classification: 'active',
  },
  {
    ...
    capabilities: [
      ...
      'squeezed_state_gen',
      'photon_counting',
      'hong_ou_mandel_effect',
      'waveguide_mode_coupling',
      'boson_sampling_sim',
    ],
    weight: 0.025,
    classification: 'active',
...
export function getQuantumSubstrate(): VerticalSubstrateConfig {
  ...
  return {
    ...
    theme: {
      ...
      icon: 'Atom',
      gradientAngle: 135,
      darkAccent: 'hsl(270 90% 60%)',
      lightAccent: 'hsl(270 80% 50%)',
    },
