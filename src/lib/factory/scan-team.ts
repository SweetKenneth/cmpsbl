...
const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  { id: 'quantum-error-correction', name: 'Quantum Error Correction Engine', description: 'Implements surface codes, Steane codes, and Shor codes. Monitors syndrome measurements and applies real-time correction cycles.', archetype: 'Active', sourcePrimitives: ['qubit', 'ripple', 'defense'], usageExample: "import { QEC } from '@cmpsbl/runtime';\nQEC.protect({ code: 'surface', distance: 3 });", minComplexity: 80 },
  ...
  { id: 'content-generation-engine', name: 'Content Generation Engine', description: 'Structured content drafting with style adherence, audience targeting, format templating, and iterative revision loops.', archetype: 'Active', sourcePrimitives: ['scribe', 'lingua', 'encode'], usageExample: "import { ContentGen } from '@cmpsbl/runtime';\nconst draft = ContentGen.write({ brief, style: 'technical' });", minComplexity: 30 },
  ...
  { id: 'tool-orchestrator', name: 'Tool Use Orchestrator', description: 'Manages API integrations, plugin lifecycle, and tool selection strategies. Agents discover, authenticate, and invoke tools autonomously.', archetype: 'Active', sourcePrimitives: ['toolkit', 'nexus', 'access'], usageExample: "import { ToolOrch } from '@cmpsbl/runtime';\nToolOrch.invoke('github', { action: 'create_pr', params });", minComplexity: 50 },
  { id: 'agent-self-healer', name: 'Agent Self-Healing System', description: 'Monitors agent health, detects degradation, triggers graceful fallback, and autonomously restarts failed agents with state recovery.', archetype: 'Hybrid', sourcePrimitives: ['overseer', 'medic', 'ripple'], usageExample: "import { AgentHealer } from '@cmpsbl/runtime';\nAgentHealer.monitor({ agents: fleet, checkInterval: 5000 });", minComplexity: 50 },
  ...
  { id: 'progress-reporter', name: 'Progress Reporter', description: 'User-facing real-time status updates with milestone tracking, ETA prediction, and human-readable summaries of agent activity.', archetype: 'Passive', sourcePrimitives: ['envoy', 'vision', 'nerve'], usageExample: "import { ProgressReporter } from '@cmpsbl/runtime';\nProgressReporter.update({ missionId, status: 'in_progress' });", minComplexity: 0 },
