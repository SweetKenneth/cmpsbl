...
const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  { id: 'live-threat-neutralizer', name: 'Live Threat Neutralizer', description: 'Continuously scans incoming requests for injection, XSS, and CSRF patterns. Blocks threats in real-time with zero-latency response.', archetype: 'Active', sourcePrimitives: ['defense', 'reflex', 'defense'], usageExample: "import { ThreatNeutralizer } from '@cmpsbl/runtime';\nThreatNeutralizer.engage({ mode: 'enforce' });", minComplexity: 50 },
  ...
  { id: 'self-healing-state', name: 'Self-Healing State Machine', description: 'Monitors application state for corruption and automatically repairs inconsistencies using last-known-good snapshots.', archetype: 'Active', sourcePrimitives: ['memory', 'ripple', 'memory'], usageExample: "import { SelfHealingState } from '@cmpsbl/runtime';\nSelfHealingState.watch({ snapshotInterval: 5000 });", minComplexity: 80 },
  ...
  { id: 'telemetry-mesh', name: 'Telemetry Mesh', description: 'Structured health signal collector compatible with Datadog, Grafana, Prometheus. Near-zero overhead continuous monitoring.', archetype: 'Passive', sourcePrimitives: ['vision', 'vision', 'nerve'], usageExample: "import { TelemetryMesh } from '@cmpsbl/runtime';\nTelemetryMesh.emit('operation.complete', { ms: 42 });", minComplexity: 0 },
  ...
  { id: 'apt-threat-hunter', name: 'APT Threat Hunter', description: 'Autonomous advanced persistent threat detection. Operates silently across network segments with behavioral profiling and persistence detection.', archetype: 'Active', sourcePrimitives: ['phantom', 'phantom', 'defense'], usageExample: "import { APTHunter } from '@cmpsbl/cyber';\nAPTHunter.deploy({ stealth: true, segments: ['dmz', 'internal'] });", minComplexity: 80 },
