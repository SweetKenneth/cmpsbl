...
const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  { id: 'attack-surface-scanner', name: 'Attack Surface Scanner', description: 'Automated reconnaissance mapping exposed services, open ports, vulnerable endpoints, and misconfigured assets. Continuous exposure scoring.', archetype: 'Active', sourcePrimitives: ['recon', 'engineer', 'beacon'], usageExample: "import { SurfaceScanner } from '@cmpsbl/cyber';\nconst report = SurfaceScanner.map({ depth: 'deep' });", minComplexity: 30 },
  ...
  { id: 'chaos-pen-test-engine', name: 'Chaos Pen Test Engine', description: 'Automated penetration testing via chaos injection, adversarial simulation, blast radius analysis, and red team automation. Validates resilience postures.', archetype: 'Active', sourcePrimitives: ['tempest', 'shadow', 'simulate'], usageExample: "import { ChaosPenTest } from '@cmpsbl/cyber';\nChaosPenTest.run({ scenario: 'ransomware', blastRadius: true });", minComplexity: 100 },
  { id: 'apt-threat-hunter', name: 'APT Threat Hunter', description: 'Autonomous advanced persistent threat detection. Operates silently across network segments with behavioral profiling and persistence detection.', archetype: 'Active', sourcePrimitives: ['wraith', 'phantom', 'sentinel'], usageExample: "import { APTHunter } from '@cmpsbl/cyber';\nAPTHunter.deploy({ stealth: true, segments: ['dmz', 'internal'] });", minComplexity: 80 },
