...
export const seoMap: Record<string, PageSEO> = {
  ...
  '/': {
    ...
    primaryKeyword: 'Clockless CMPSBL World Engine',
  },
  '/os': {
    title: 'CMPSBL World Engine — AI Operating System',
    description: 'Explore the CMPSBL World Engine: 21 runtime modules, real-time telemetry, and autonomous orchestration powering cognitive workloads.',
    ogTitle: 'CMPSBL World Engine — The Engine Behind Clockless',
    ...
    keywords: ['CMPSBL World Engine', 'AI runtime', 'cognitive orchestration', 'module telemetry', 'AI workload management', 'Clockless'],
    schema: 'feature',
    intent: 'Feature/Capability',
    primaryKeyword: 'CMPSBL World Engine',
  },
  '/ai-operating-system': {
