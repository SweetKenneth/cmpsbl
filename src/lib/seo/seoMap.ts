...
export const seoMap: Record<string, PageSEO> = {
  ...
  '/': {
    ...
    ogTitle: 'Clockless — A Cognitive Reality System',
    ogDescription: 'Where machines learn to persist, evolve, coordinate, and compound.',
    ogImage: OG_DEFAULT,
    keywords: ['Clockless', 'Cognitive Reality', 'CMPSBL Substrate', 'persistent intelligence', 'autonomous AI', 'governed evolution', 'AI infrastructure'],
    schema: 'home',
    intent: 'Brand/Category',
    primaryKeyword: 'Clockless Cognitive Reality',
  },
  '/os': {
    title: 'CMPSBL Substrate — Cognitive Runtime',
    ...
    ogTitle: 'CMPSBL Substrate — The Runtime Behind Clockless',
    ogDescription: 'Real-time telemetry, module health, and autonomous orchestration inside the cognitive runtime.',
    ogImage: OG_SUBSTRATE_OS,
    keywords: ['CMPSBL Substrate', 'AI runtime', 'cognitive orchestration', 'module telemetry', 'AI workload management', 'Clockless'],
    schema: 'feature',
    intent: 'Feature/Capability',
    primaryKeyword: 'CMPSBL Substrate',
  },
  '/ai-operating-system': {
