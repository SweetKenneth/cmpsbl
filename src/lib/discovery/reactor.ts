...
const SYNTHESIS_TEMPLATES: SynthesisTemplate[] = [
  ...
  { namePattern: 'Evolution-Encode Legacy Transcoding Bridge', descriptionPattern: 'Real-time transcoding of legacy interfaces into modern semantic encodings enabling legacy participation in cognitive pipelines', category: 'integration', modulePattern: ['EVOLUTION', 'ENCODE', 'INTEGRATION', 'DECODE'], entryPattern: 'legacy-transcoder', exitPattern: 'encoding-bridged', errorStrategy: 'fallback', maxExecutionMs: 5000, baseBreakdown: { strategicLeverage: 92, recursionPotential: 78, crossNodeImpact: 88, composability: 90, governanceInfluence: 62, moatSensitivity: 88 }, discoveredBy: 'reactor', rationale: 'Legacy systems contain irreplaceable business logic — transcoding bridges modernize access without requiring rewrites' },
