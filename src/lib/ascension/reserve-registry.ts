...
const AGENT_FORGE_PRIMITIVES: ReservePrimitive[] = [
  {
    ...
    affinitySignals: [
      ...
      'input_check', 'boundary', 'escape', 'restrict',
    ],
    baseWeight: 0.85,
    icon: 'Shield',
  },
  {
    ...
    affinitySignals: [
      ...
      'team', 'collaborate', 'handoff', 'pipeline',
    ],
    baseWeight: 0.90,
    icon: 'Network',
  },
  {
    ...
    affinitySignals: [
      ...
      'cheap', 'expensive', 'optimize', 'batch',
    ],
    baseWeight: 0.80,
    icon: 'Coins',
  },
  {
    ...
    affinitySignals: [
      ...
      'state', 'persistent', 'recall', 'continuity', 'profile',
    ],
    baseWeight: 0.75,
    icon: 'User',
  },
  {
    ...
    affinitySignals: [
      ...
      'lock', 'mutex', 'semaphore', 'race', 'compete', 'resource',
    ],
    baseWeight: 0.78,
    icon: 'Scale',
  },
