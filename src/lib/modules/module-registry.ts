...
export const MODULE_REGISTRY: ModuleInfo[] = [
  ...
  },
  {
    ...
    heroDescription: "AUDIT provides an immutable, cryptographically-chained event ledger that captures every significant action across all modules and zones — built for SOC2, GDPR, and legal defensibility.",
