...
<div class="doc-container cover">
  ...
  <p class="cover-subtitle">
    ...
    A closed-loop reactor that crystallizes latent capabilities from the 40-primitive topology
...
<div class="doc-container">
  ...
  <ul class="checklist">
    <li><strong>Discovers</strong> latent capabilities by combinatorially exploring the 40-primitive topology</li>
  ...
  <table>
    ...
    <tr><td>Exploration breadth</td><td>40 primitives × combinatorial chains</td><td>Full topology coverage</td></tr>
  ...
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <p>ZIP packages with manifest, CMPSBL® Convex Core™ Processing Layer, Discovery Engine, and README.</p>
    </div>
  </div>

  <div class="stream-line"></div>

   <h2 id="standalone">6. CMPSBL® Convex Core™ Processing Layer</h2>
  ...
  <ul class="checklist">
    ...
    <li>Pairs with the CMPSBL® Convex Core™ Processing Layer for CJPI scoring</li>
...
<div class="doc-container">
  ...
  <h3>Core Loop</h3>
  <pre><code>Input:  40-primitive topology graph
...
CJPI = (0.25 × novelty + 0.30 × utility + 0.20 × complexity + 0.25 × composability) × 100</code></pre>
  ...
  <h2 id="standalone">7. CMPSBL® Convex Core™ Processing Layer</h2>
  <div class="card-grid">
    <div class="card">
      <h4 style="margin-top:0;">Convex Core™ Processing Layer</h4>
    ...
    <div class="card">
      <h4 style="margin-top:0;">Convex Core™ Discovery Engine</h4>
...
<div class="doc-container">
  ...
  <table>
    ...
    <tr><td>40-primitive topology</td><td>4-category architecture with field permeation</td><td>No competitor has this topological completeness</td></tr>
...
└── metadata.json                    # Export metadata + fingerprint</code></pre>
  ...
  <ol>
    ...
    <li>Include CMPSBL® Convex Core™ Processing Layer (TypeScript native, others generate stubs)</li>
  </ol>
