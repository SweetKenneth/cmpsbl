...
<div class="page">
  ...
  <ul class="checklist">
    ...
    <li><strong>Materialization</strong> — Exporting a pipeline into the CMPSBL® Convex Core™ Processing Layer you own</li>
  </ul>
</div>
...
<div class="page">
  ...
  <p><strong>Materialization</strong> is the process of exporting a crystallized pipeline into the CMPSBL® Convex Core™ Processing Layer you own. Every materialized pipeline includes:</p>
  <ul class="checklist">
    <li>The <strong>CMPSBL® Convex Core™ Processing Layer</strong> — portable runtime</li>
