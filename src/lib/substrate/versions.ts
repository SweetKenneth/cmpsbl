 ...
 * SPARTA Epoch v11.2.0 — Zone Architecture
 *
 * 10 Public Entities:
...
export const MODULE_VERSIONS = {
  // Kernel (boots first)
  core: { version: '11.2.0', codename: 'Foundation', layer: 'Kernel', type: 'kernel' as const },
  // 8 Public Modules
  decode: { version: '11.2.0', codename: 'Interpreter', layer: 'Cognitive', type: 'module' as const },
  encode: { version: '11.2.0', codename: 'Genesis', layer: 'Orchestration', type: 'module' as const },
  vision: { version: '11.2.0', codename: 'Vee', layer: 'Operational', type: 'module' as const },
  cortex: { version: '11.2.0', codename: 'Orchestrator', layer: 'Orchestration', type: 'module' as const },
  nexus: { version: '11.2.0', codename: 'Router', layer: 'Orchestration', type: 'module' as const },
  economy: { version: '11.2.0', codename: 'Treasury', layer: 'Infrastructure', type: 'module' as const },
  sandbox: { version: '11.2.0', codename: 'Crucible', layer: 'Infrastructure', type: 'module' as const },
  inclusive: { version: '11.2.0', codename: 'Clarity', layer: 'Operational', type: 'module' as const },
  // Module (boots last)
  integration: { version: '11.2.0', codename: 'Bridge', layer: 'Operational', type: 'module' as const },
} as const;

// 5 Mesh Overlays (protective layers — outermost to innermost)
export const MESH_VERSIONS = {
  defense: { version: '11.2.0', codename: 'Guardian', order: 1, position: 'outermost' as const },
  immunity: { version: '11.2.0', codename: 'Sentinel', order: 2, position: 'outer' as const },
  evolution: { version: '11.2.0', codename: 'Phoenix', order: 3, position: 'middle' as const },
  intent: { version: '11.2.0', codename: 'Compass', order: 4, position: 'inner' as const },
  governance: { version: '11.2.0', codename: 'Arbiter', order: 5, position: 'innermost' as const },
} as const;

// 9 Zone versions (surgically hot-swappable subsystems within CCR/CCL)
export const ZONE_VERSIONS = {
  // CCR Zones (Layer 0)
  system: { version: '11.2.0', codename: 'Production', parent: 'CCR', description: 'Administration & config' },
  brain: { version: '11.2.0', codename: 'Memoria', parent: 'CCR', description: 'Reasoning & learning' },
  memory: { version: '11.2.0', codename: 'Vault', parent: 'CCR', description: 'Persistent storage & retrieval' },
  dream: { version: '11.2.0', codename: 'Nocturne', parent: 'CCR', description: 'Offline synthesis & evolution' },
  // CCL Zones (Layer 1)
  ripple: { version: '11.2.0', codename: 'Cascade', parent: 'CCL', description: 'Event bus & signal propagation' },
  access: { version: '11.2.0', codename: 'Gatekeeper', parent: 'CCL', description: 'API keys & rate limiting' },
  identity: { version: '11.2.0', codename: 'Provenance', parent: 'CCL', description: 'Actor identity & trust' },
  relay: { version: '11.2.0', codename: 'Dispatch', parent: 'CCL', description: 'Webhook & outbound routing' },
  audit: { version: '11.2.0', codename: 'Ledger', parent: 'CCL', description: 'Immutable compliance logging' },
} as const;

// Absorbed module (routes to EVOLUTION mesh)
export const ABSORBED_VERSIONS = {
  modernizer: { version: '11.2.0', codename: 'Architect', absorbedBy: 'evolution', description: 'Self-upgrade → EVOLUTION mesh' },
} as const;

// Control plane versions
export const CONTROL_PLANE_VERSIONS = {
  atlas: { version: '11.2.0', codename: 'Prometheus', description: 'Centralized Control Plane' },
  seba: { version: '2.1.0', codename: 'Full Spectrum Autonomy', description: 'Self-Evolving Bounded Agent' },
  encode: { version: '11.2.0', codename: 'Genesis', description: 'Code Execution Intelligence' },
  clm: { version: '11.2.0', codename: 'Perpetual', description: 'Constant Learning Mode' },
} as const;
