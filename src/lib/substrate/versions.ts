 ...
 * v8.5.0 — SYNERGY+ Epoch — Single source of truth for all module versions
 */
...
export const CONTROL_PLANE_VERSIONS = {
  atlas: { version: '8.5.0', codename: 'Prometheus', description: 'Centralized Control Plane' },
  seba: { version: '2.0.0', codename: 'Full Spectrum Autonomy', description: 'Self-Evolving Bounded Agent' },
  encoded: { version: '2.2.0', codename: 'Genesis', description: 'Implementation Executor' },
  clm: { version: '8.5.0', codename: 'Perpetual', description: 'Constant Learning Mode' },
} as const;
