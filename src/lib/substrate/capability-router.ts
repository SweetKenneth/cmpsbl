...
registerCapability('economy', 'consensus_pricing', 90);
registerCapability('economy', 'pricing_anomaly_detection', 85);
registerCapability('economy', 'batch_repricing_governance', 80);
