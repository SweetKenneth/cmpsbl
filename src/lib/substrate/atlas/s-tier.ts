/**
 * ATLAS — S-Tier Primitives
 * Capability gating, entitlement resolution, impact forecasting, recursive discovery
 */
export * from '@/crownjewels/s-tier/074-capability-gate-engine';
