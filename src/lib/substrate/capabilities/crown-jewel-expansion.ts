...
export const CROWN_JEWEL_EXPANSION: Record<string, Omit<CapabilityDefinition, 'id'> & { id: string }> = {
  ...
  nrv_health_pulse_monitor: { id: 'nrv_health_pulse_monitor', name: 'Health Pulse Monitor', description: 'Monitors heartbeat pulses from all 40 nodes with configurable failure thresholds', modules: ['NERVE', 'VISION', 'SYSTEM'], layer: 'Kernel', userBenefit: 'Instant detection of node failures', status: 'active', emergentFrom: 'nerve-pulse-v1', riskLevel: 'low', executionMode: 'streaming' },
  ...
  nrv_operational_readiness_scorer: { id: 'nrv_operational_readiness_scorer', name: 'Operational Readiness Scorer', description: 'Scores system-wide operational readiness across all 40 nodes', modules: ['NERVE', 'VISION', 'ENGINEER'], layer: 'Kernel', userBenefit: 'Know if the system is ready for action', status: 'active', emergentFrom: 'nerve-ready-v1', riskLevel: 'low', executionMode: 'sync' },
