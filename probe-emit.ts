...
`;
const cap = [{ id:'p',name:'probe',description:'p',chain:['DEFENSE','GOVERNANCE','COMPASS'],cjpiScore:50,tier:'mint' as const,fingerprint:'0123456789abcdef0123456789abcdef',moatSignature:'m',capabilityType:'utility'}];
