...
const VERSION_PATTERNS = [
  // Explicit version strings like v9.1.0, v9.2.0, v9.3.0, v10.0.0
  { regex: /v(9\.\d+\.\d+|10\.0\.0)/g, replacement: `v${NEW_VERSION}` },
  // Bare version strings like "Version 9.1.0", "version: '9.1.0'"
  { regex: /(?<=Version\s|version[:\s='"]+)(9\.\d+\.\d+|10\.0\.0)/g, replacement: NEW_VERSION },
  // In code comments like "v9.1.0 ARCHITECT"
  { regex: /(?<=\*\s*)v(9\.\d+\.\d+|10\.0\.0)/g, replacement: `v${NEW_VERSION}` },
];
