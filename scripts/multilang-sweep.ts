...
const LANGS: LangConfig[] = [
  ...
  { id: 'lua',        ext: 'lua',  parser: 'lua -p "{file}" 2>&1 || luac -p "{file}"',                       fileGlob: /\.lua$/i },
  { id: 'php',        ext: 'php',  parser: 'php -l "{file}"',                                                fileGlob: /\.php$/i },
  { id: 'go',         ext: 'go',   parser: 'gofmt -e "{file}" > /dev/null',                                  fileGlob: /\.go$/i },
  { id: 'rust',       ext: 'rs',   parser: null,                                                              fileGlob: /\.rs$/i },
  { id: 'java',       ext: 'java', parser: null,                                                              fileGlob: /\.java$/i },
  { id: 'csharp',     ext: 'cs',   parser: null,                                                              fileGlob: /\.cs$/i },
