...
const CORPUS: Sample[] = [
  ...
  { file: 'js-class.js', lang: 'javascript', intent: 'es6 class',
  ...
  { file: 'ts-zod.ts', lang: 'typescript', intent: 'schema validation',
  ...
  { file: 'py-flask.py', lang: 'python', intent: 'flask handlers',
  ...
  // ── Ruby (2) ────────────────────────────────────────────────────────────
  { file: 'rb-app.rb', lang: 'ruby', intent: 'class + methods',
  ...
  { file: 'php-route.php', lang: 'php', intent: 'route handlers',
  ...
  // ── Edge / hostile (5) ──────────────────────────────────────────────────
  { file: 'edge-empty.ts', lang: 'typescript', intent: 'empty file', content: `` },
