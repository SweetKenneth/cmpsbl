...
export const prerenderRoutes: PrerenderRoute[] = [
  ...
  { path: '/memory-stream', title: 'Memory Stream — Signal to Silicon | CMPSBL', description: 'Autonomous software discovery where raw signals crystallize into scored, exportable pipelines with persistent vault state.', ogTitle: 'Memory Stream — Signal to Silicon', ogDescription: 'Raw signals crystallize into scored, exportable software pipelines.', ogImage: `${OG_BASE}/og/home.jpg`, keywords: ['memory stream', 'signal to silicon', 'pipeline crystallization'] },
  { path: '/foundry', title: 'Software Foundry — Pipeline Factory | CMPSBL', description: 'Production pipeline factory where discovery outputs are refined, scored, and materialized into deployable software artifacts.', ogTitle: 'Software Foundry — Pipeline Factory', ogDescription: 'Refine and materialize discovery outputs into deployable artifacts.', ogImage: `${OG_BASE}/og/store.jpg`, keywords: ['software foundry', 'pipeline factory'] },
  { path: '/evolution-mesh', title: 'EVOLUTION Mesh — Governed Improvement | CMPSBL', description: 'Self-improving substrate with shadow-run validation, governed promotion pipelines, and version-controlled architectural mutations.', ogTitle: 'EVOLUTION Mesh — Governed Improvement', ogDescription: 'Shadow-run validation and governed promotion for evolution.', ogImage: `${OG_BASE}/og/architecture.jpg`, keywords: ['evolution mesh', 'governed improvement'] },
  { path: '/roadmap', title: 'Roadmap — Architecture Evolution | CMPSBL', description: 'Ongoing architectural evolution: sector expansion, capability growth, and infrastructure deepening over time.', ogTitle: 'Roadmap — Architecture Evolution', ogDescription: 'Sector expansion and capability growth over time.', ogImage: `${OG_BASE}/og/documentation.jpg`, keywords: ['architecture evolution', 'roadmap'] },
