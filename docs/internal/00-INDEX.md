...
| 05 | [Evolution Engine Internals](./05-EVOLUTION-INTERNALS.md) | How self-improvement actually works | 🔴 Critical |
...
| 09 | [NEXUS Routing Logic](./09-NEXUS-INTERNALS.md) | Provider selection algorithms, cost optimization | 🟡 Medium |
...
| 15 | [Tiering & Access Control](./15-TIERING-ACCESS.md) | Enterprise/Pro/Free tier logic, entitlements, crown jewel lockdown | 🔴 High |
...
- **🔴 Critical/High** — Restricted to founders, lead engineers, and authorized investors under NDA
- **🟡 Medium** — Available to all internal team members
- **🟢 Low** — May be shared with contractors and consultants under NDA
