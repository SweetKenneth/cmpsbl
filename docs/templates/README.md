...
| 4 | [Service Registry](./04-service-registry.md) | BRAIN | Dependency-aware service discovery | Plugin systems |
...
| 10 | [State Machine](./10-state-machine.md) | BRAIN | FSM with guards, effects, and snapshots | Workflows, agent lifecycles |
...
| 16 | [Scheduler Engine](./16-scheduler-engine.md) | BRAIN | Deferred execution with retry & dead-letter | Background jobs, cron |
