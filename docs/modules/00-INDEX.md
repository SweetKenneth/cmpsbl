...
# 📖 CMPSBL OS Substrate — Module Deep Dives
...
The substrate consists of **21 modules** across **6 architectural layers**, each with a specific role in the cognitive operating system.
...
| Doc | Module | Purpose |
|-----|--------|---------|
| [01](./01-CORE.md) | **CORE** | Foundation primitives, health, lifecycle |
| [02](./02-RIPPLE.md) | **RIPPLE** | Event bus, message routing, job queue |
| [03](./03-ACCESS.md) | **ACCESS** | Authentication, API keys, entitlements |
