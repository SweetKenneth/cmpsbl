 ...
 * 
 * Detects bots using user agent analysis, request velocity, and headless browser patterns
 *
 * @package BotSniper
 */
...
class BotDetector {
    ...
    /**
     * Check request velocity for current IP
     */
    private function check_request_velocity() {
        $ip = $this->get_client_ip();
        $transient_key = 'bot_sniper_velocity_' . md5($ip);
