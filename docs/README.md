...
| Directory | Audience | Contains Trade Secrets |
|-----------|----------|----------------------|
| [`/docs/library/`](./library/) | Investors, researchers, developers | No |
...
Start with [`/docs/library/00-INDEX.md`](./library/00-INDEX.md) — comprehensive system overview without proprietary details.

### For Internal Team
Start with [`/docs/internal/00-INDEX.md`](./internal/00-INDEX.md) — full trade secrets, architecture internals, and operational guides.
...
| **IDENTITY upgrades** | Actor reputation scoring (5 tiers), cross-agency identity portability |
| **ECONOMY upgrades** | Predictive cost forecasting, per-capability cost attribution |
| **SANDBOX upgrades** | Hard resource limit enforcement, snapshot/restore system |
